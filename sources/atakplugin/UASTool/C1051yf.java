...
/* renamed from: atakplugin.UASTool.yf */
public class C1051yf extends C1018xc {

    /* renamed from: d */
    static int[][][][] f7677d;

    /* renamed from: e */
    private final C1007ws f7678e;

    /* renamed from: f */
    private List<C1024xh> f7679f;

    /* renamed from: g */
    private long[] f7680g;

    /* renamed from: h */
    private C1027xk f7681h;

    /* renamed from: i */
    private C0737pi f7682i;
    ...
    public C1051yf(C1007ws wsVar) {
        this(wsVar, "eng");
    }

    public C1051yf(C1007ws wsVar, String str) {
        super(wsVar.toString());
        C1027xk xkVar = new C1027xk();
        this.f7681h = xkVar;
        this.f7678e = wsVar;
        xkVar.mo6176a(str);
        this.f7679f = m14700j();
        this.f7682i = new C0737pi();
        C0793rd i = m14699i();
        this.f7682i.mo170a((C0688nt) i);
        this.f7681h.mo6182b(new Date());
        this.f7681h.mo6177a(new Date());
        this.f7681h.mo6176a(str);
        this.f7681h.mo6174a(i.mo5589i());
        this.f7681h.mo6172a(1.0f);
    }
    ...
    /* renamed from: i */
    private C0793rd m14699i() {
        int i;
        adi adi = new adi(this.f7679f.get(0).mo9b());
        if (adi.mo315a(16) == 2935) {
            ...
            if (a3 != 16) {
                ...
                switch (a5) {
                    ...
                    case 7:
                        int a6 = adi.mo315a(1);
                        C0793rd rdVar = new C0793rd(C0793rd.f6038h);
                        rdVar.mo5577b(2);
                        rdVar.mo5573a((long) i);
                        rdVar.mo204a(1);
                        rdVar.mo5579c(16);
                        aam aam = new aam();
                        aam.mo39d(a5);
    ...
    /* renamed from: a */
    private int m14698a(int i, int i2) {
        int i3 = i >>> 1;
        int i4 = i & 1;
        if (i3 <= 18 && i4 <= 1 && i2 <= 2) {
            return f7677d[i3][i4][i2][1] * 2;
        }
        throw new RuntimeException("Cannot determine framesize of current sample");
    }

    /* renamed from: j */
    private List<C1024xh> m14700j() {
        ByteBuffer allocate = ByteBuffer.allocate(5);
        ArrayList arrayList = new ArrayList();
        while (-1 != this.f7678e.mo5650a(allocate)) {
            long a = (long) m14698a(allocate.get(4) & bxu.f4219a, allocate.get(4) >> 6);
            arrayList.add(new C1052yg(this, this.f7678e.mo5655b() - 5, a, this.f7678e));
            C1007ws wsVar = this.f7678e;
            wsVar.mo5654a((wsVar.mo5655b() - 5) + a);
            allocate.rewind();
        }
    ...
    static {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: atakplugin.UASTool.C1051yf.<clinit>():void");
    }
}
