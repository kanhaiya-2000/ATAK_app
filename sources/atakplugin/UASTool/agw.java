...
public class agw extends ahl {

    /* renamed from: J */
    private static final int f1197J = 31;

    /* renamed from: K */
    private static final int f1198K = 32;

    /* renamed from: L */
    private static final int f1199L = 33;

    /* renamed from: M */
    private static final int f1200M = 34;

    /* renamed from: a */
    static int f1201a = 1024;

    /* renamed from: b */
    static int f1202b = 1024;

    /* renamed from: c */
    static int f1203c = 1024;

    /* renamed from: d */
    static final int f1204d = 0;

    /* renamed from: e */
    static final int f1205e = 1;
    ...
    public void mo824a(air air, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        this.f1217j = bArr4;
        try {
            this.f1282F = (agz) Class.forName(air.mo1083i("sha-256")).newInstance();
            this.f1282F.mo834a();
        } catch (Exception e) {
            System.err.println(e);
        }
        this.f1208P = new afx();
        this.f1209Q = new ahy(this.f1208P);
        try {
            ags ags = (ags) Class.forName(air.mo1083i("dh")).newInstance();
            this.f1213f = ags;
            ags.mo817a();
            this.f1209Q.mo996a();
            this.f1208P.mo618a((byte) 34);
            this.f1208P.mo619a(f1201a);
            this.f1208P.mo619a(f1202b);
            this.f1208P.mo619a(f1203c);
            air.mo1061b(this.f1209Q);
            if (ahg.m1351f().mo908a(1)) {
                ahu f = ahg.m1351f();
                f.mo907a(1, "SSH_MSG_KEX_DH_GEX_REQUEST(" + f1201a + "<" + f1202b + "<" + f1203c + ") sent");
    ...
    public boolean mo825a(atakplugin.UASTool.afx r12) {
        ...
        L_0x0030:
            ...
            byte[] r0 = r12.mo641h()
            byte[] r12 = r12.mo643j()
            atakplugin.UASTool.ags r1 = r11.f1213f
            r1.mo821c(r0)
            atakplugin.UASTool.ags r1 = r11.f1213f
            byte[] r1 = r1.mo822c()
            byte[] r1 = r11.mo912a((byte[]) r1)
            r11.f1283G = r1
            atakplugin.UASTool.afx r1 = r11.f1208P
            r1.mo644k()
            atakplugin.UASTool.afx r1 = r11.f1208P
            byte[] r2 = r11.f1215h
            r1.mo627b((byte[]) r2)
            ...
            atakplugin.UASTool.afx r1 = r11.f1208P
            r1.mo631c((byte[]) r0)
            atakplugin.UASTool.afx r0 = r11.f1208P
            byte[] r1 = r11.f1283G
            r0.mo631c((byte[]) r1)
            atakplugin.UASTool.afx r0 = r11.f1208P
            int r0 = r0.mo617a()
            byte[] r1 = new byte[r0]
            atakplugin.UASTool.afx r2 = r11.f1208P
            r2.mo635d((byte[]) r1)
        ...
        L_0x02f6:
            ...
            byte[] r12 = r12.mo641h()
            r11.f1211S = r12
            atakplugin.UASTool.ags r12 = r11.f1213f
            byte[] r0 = r11.f1210R
            r12.mo818a(r0)
            atakplugin.UASTool.ags r12 = r11.f1213f
            byte[] r0 = r11.f1211S
            ...
            byte[] r12 = r12.mo820b()
            r11.f1212T = r12
            atakplugin.UASTool.ahy r12 = r11.f1209Q
            r12.mo996a()
            atakplugin.UASTool.afx r12 = r11.f1208P
            r0 = 32
            r12.mo618a((byte) r0)
            atakplugin.UASTool.afx r12 = r11.f1208P
            byte[] r0 = r11.f1212T
            ...
            atakplugin.UASTool.ahy r0 = r11.f1209Q
        ...
        L_0x034e:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: atakplugin.UASTool.agw.mo825a(atakplugin.UASTool.afx):boolean");
    }

    /* renamed from: a */
    public String mo823a() {
        return this.f1206N == 1 ? "DSA" : "RSA";
    }
