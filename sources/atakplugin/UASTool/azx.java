...
public final class azx extends ban {

    /* renamed from: a */
    final /* synthetic */ bdl f2450a;

    /* renamed from: b */
    final /* synthetic */ ayd f2451b;

    /* renamed from: c */
    private int f2452c;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public azx(bdl bdl, ayd ayd, ayd ayd2) {
        super(ayd2);
        this.f2450a = bdl;
        this.f2451b = ayd;
    }
    ...
    public Object mo2064a(Object obj) {
        ...
        if (i == 0) {
            this.f2452c = 1;
            apk.m2620a(obj);
            return this.f2450a.invoke(this);
        } else if (i == 1) {
            this.f2452c = 2;
            apk.m2620a(obj);
            return obj;
