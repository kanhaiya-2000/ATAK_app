...
public class msg_gps_rtk extends MAVLinkMessage {
    ...
    public MAVLinkPacket pack() {
        ...
        mAVLinkPacket.payload.putShort(this.f8150wn);
    ...
    public void unpack(MAVLinkPayload mAVLinkPayload) {
        ...
        this.f8150wn = mAVLinkPayload.getShort();
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_GPS_RTK - time_last_baseline_ms:" + this.time_last_baseline_ms + " tow:" + this.tow + " baseline_a_mm:" + this.baseline_a_mm + " baseline_b_mm:" + this.baseline_b_mm + " baseline_c_mm:" + this.baseline_c_mm + " accuracy:" + this.accuracy + " iar_num_hypotheses:" + this.iar_num_hypotheses + " wn:" + this.f8150wn + " rtk_receiver_id:" + this.rtk_receiver_id + " rtk_health:" + this.rtk_health + " rtk_rate:" + this.rtk_rate + " nsats:" + this.nsats + " baseline_coords_type:" + this.baseline_coords_type + "";
    }
}
