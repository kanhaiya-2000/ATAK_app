...
public class msg_highres_imu extends MAVLinkMessage {
    ...
    public MAVLinkPacket pack() {
        ...
        mAVLinkPacket.payload.putFloat(this.gyro_temperature);
        mAVLinkPacket.payload.putShort(this.fields_updated);
    ...
    public void unpack(MAVLinkPayload mAVLinkPayload) {
        ...
        this.gyro_temperature = mAVLinkPayload.getFloat();
        this.fields_updated = mAVLinkPayload.getShort();
    }
