...
public class msg_hil_optical_flow extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_HIL_OPTICAL_FLOW - time_usec:" + this.time_usec + " flow_comp_m_x:" + this.flow_comp_m_x + " flow_comp_m_y:" + this.flow_comp_m_y + " ground_distance:" + this.ground_distance + " flow_x:" + this.flow_x + " flow_y:" + this.flow_y + " sensor_id:" + this.sensor_id + " quality:" + this.quality + "";
    }
}
