...
public class msg_set_global_position_setpoint_int extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SET_GLOBAL_POSITION_SETPOINT_INT - latitude:" + this.latitude + " longitude:" + this.longitude + " altitude:" + this.altitude + " yaw:" + this.yaw + " coordinate_frame:" + this.coordinate_frame + "";
    }
}
