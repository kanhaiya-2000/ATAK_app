...
public class msg_simstate extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SIMSTATE - roll:" + this.roll + " pitch:" + this.pitch + " yaw:" + this.yaw + " xacc:" + this.xacc + " yacc:" + this.yacc + " zacc:" + this.zacc + " xgyro:" + this.xgyro + " ygyro:" + this.ygyro + " zgyro:" + this.zgyro + " latitude:" + this.lat + " longitude:" + this.lng + "";
    }
}
