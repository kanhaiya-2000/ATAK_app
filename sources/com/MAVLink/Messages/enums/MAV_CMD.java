...
public class MAV_CMD {
    ...
    public static final int MAV_CMD_FAVOR_MISSION_CONTROL = 107;
    public static final int MAV_CMD_FAVOR_MISSION_SET = 109;
    public static final int MAV_CMD_FAVOR_POSITION = 106;
    public static final int MAV_CMD_FAVOR_QUERY = 29;
    public static final int MAV_CMD_FAVOR_WP_SPEED = 26;
    public static final int MAV_CMD_IMAGE_START_CAPTURE = 2000;
    public static final int MAV_CMD_IMAGE_STOP_CAPTURE = 2001;
    public static final int MAV_CMD_LOITER_VELOCITY = 109;
    public static final int MAV_CMD_MISSION_START = 300;
    public static final int MAV_CMD_NAV_FOLLOWME = 96;
    ...
    public static final int MAV_CMD_OPEN_FLY_DATA = 105;
    ...
    public static final int MAV_CMD_REQUEST_HOT_POINT = 111;
    ...
    public static final int MAV_CMD_VIRTUALJOYSTIVK_CONTROLMODE = 23;
    public static final int MAV_CMD_VIRTUALJOYSTIVK_STATE = 24;
    public static final int MAV_CMD_VIRTUALJOYSTIVK_YAWMODE_STATE = 25;
    public static final int MAV_CMD_YAW_RECOVER = 110;
}
