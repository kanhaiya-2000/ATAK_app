...
public class msg_ahrs extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_AHRS - sysid:" + this.sysid + " compid:" + this.compid + " omegaIx:" + this.omegaIx + " omegaIy:" + this.omegaIy + " omegaIz:" + this.omegaIz + " accel_weight:" + this.accel_weight + " renorm_val:" + this.renorm_val + " error_rp:" + this.error_rp + " error_yaw:" + this.error_yaw + "";
    }
}
