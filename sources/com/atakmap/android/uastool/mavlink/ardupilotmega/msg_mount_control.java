...
public class msg_mount_control extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_MOUNT_CONTROL - sysid:" + this.sysid + " compid:" + this.compid + " input_a:" + this.input_a + " input_b:" + this.input_b + " input_c:" + this.input_c + " target_system:" + this.target_system + " target_component:" + this.target_component + " save_position:" + this.save_position + "";
    }
}
