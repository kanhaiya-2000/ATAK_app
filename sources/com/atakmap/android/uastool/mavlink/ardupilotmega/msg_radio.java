...
public class msg_radio extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_RADIO - sysid:" + this.sysid + " compid:" + this.compid + " rxerrors:" + this.rxerrors + " fixed:" + this.fixed + " rssi:" + this.rssi + " remrssi:" + this.remrssi + " txbuf:" + this.txbuf + " noise:" + this.noise + " remnoise:" + this.remnoise + "";
    }
}
