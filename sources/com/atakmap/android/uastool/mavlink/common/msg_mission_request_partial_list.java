...
public class msg_mission_request_partial_list extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_MISSION_REQUEST_PARTIAL_LIST - sysid:" + this.sysid + " compid:" + this.compid + " start_index:" + this.start_index + " end_index:" + this.end_index + " target_system:" + this.target_system + " target_component:" + this.target_component + "";
    }
}
