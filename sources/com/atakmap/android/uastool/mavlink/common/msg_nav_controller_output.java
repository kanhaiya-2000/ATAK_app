...
public class msg_nav_controller_output extends MAVLinkMessage {
    ...
    public MAVLinkPacket pack() {
        ...
        mAVLinkPacket.payload.putUnsignedShort(this.wp_dist);
    ...
    public void unpack(MAVLinkPayload mAVLinkPayload) {
        ...
        this.wp_dist = mAVLinkPayload.getUnsignedShort();
    }
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT - sysid:" + this.sysid + " compid:" + this.compid + " nav_roll:" + this.nav_roll + " nav_pitch:" + this.nav_pitch + " alt_error:" + this.alt_error + " aspd_error:" + this.aspd_error + " xtrack_error:" + this.xtrack_error + " nav_bearing:" + this.nav_bearing + " target_bearing:" + this.target_bearing + " wp_dist:" + this.wp_dist + "";
    }
}
