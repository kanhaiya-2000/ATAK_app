...
public class msg_safety_set_allowed_area extends MAVLinkMessage {
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA - sysid:" + this.sysid + " compid:" + this.compid + " p1x:" + this.p1x + " p1y:" + this.p1y + " p1z:" + this.p1z + " p2x:" + this.p2x + " p2y:" + this.p2y + " p2z:" + this.p2z + " target_system:" + this.target_system + " target_component:" + this.target_component + " frame:" + this.frame + "";
    }
}
