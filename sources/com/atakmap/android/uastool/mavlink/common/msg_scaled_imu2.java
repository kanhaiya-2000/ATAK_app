...
public class msg_scaled_imu2 extends MAVLinkMessage {
    ...
    public MAVLinkPacket pack() {
        ...
        mAVLinkPacket.msgid = 116;
        mAVLinkPacket.crc_extra = 76;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SCALED_IMU2 - sysid:" + this.sysid + " compid:" + this.compid + " time_boot_ms:" + this.time_boot_ms + " xacc:" + this.xacc + " yacc:" + this.yacc + " zacc:" + this.zacc + " xgyro:" + this.xgyro + " ygyro:" + this.ygyro + " zgyro:" + this.zgyro + " xmag:" + this.xmag + " ymag:" + this.ymag + " zmag:" + this.zmag + "";
    }
}
