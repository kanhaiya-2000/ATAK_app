...
public class msg_sim_state extends MAVLinkMessage {
    ...
    /* renamed from: q1 */
    public float f8348q1;

    /* renamed from: q2 */
    public float f8349q2;

    /* renamed from: q3 */
    public float f8350q3;

    /* renamed from: q4 */
    public float f8351q4;
    public float roll;
    public float std_dev_horz;
    public float std_dev_vert;

    /* renamed from: vd */
    public float f8352vd;

    /* renamed from: ve */
    public float f8353ve;

    /* renamed from: vn */
    public float f8354vn;
    public float xacc;
    public float xgyro;
    public float yacc;
    public float yaw;
    ...
    public MAVLinkPacket pack() {
        ...
        mAVLinkPacket.crc_extra = 32;
        mAVLinkPacket.payload.putFloat(this.f8348q1);
        mAVLinkPacket.payload.putFloat(this.f8349q2);
        mAVLinkPacket.payload.putFloat(this.f8350q3);
        mAVLinkPacket.payload.putFloat(this.f8351q4);
        ...
        mAVLinkPacket.payload.putFloat(this.f8354vn);
        mAVLinkPacket.payload.putFloat(this.f8353ve);
        mAVLinkPacket.payload.putFloat(this.f8352vd);
        return mAVLinkPacket;
    }

    public void unpack(MAVLinkPayload mAVLinkPayload) {
        mAVLinkPayload.resetIndex();
        this.f8348q1 = mAVLinkPayload.getFloat();
        this.f8349q2 = mAVLinkPayload.getFloat();
        this.f8350q3 = mAVLinkPayload.getFloat();
        this.f8351q4 = mAVLinkPayload.getFloat();
        ...
        this.f8354vn = mAVLinkPayload.getFloat();
        this.f8353ve = mAVLinkPayload.getFloat();
        this.f8352vd = mAVLinkPayload.getFloat();
    }
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SIM_STATE - sysid:" + this.sysid + " compid:" + this.compid + " q1:" + this.f8348q1 + " q2:" + this.f8349q2 + " q3:" + this.f8350q3 + " q4:" + this.f8351q4 + " roll:" + this.roll + " pitch:" + this.pitch + " yaw:" + this.yaw + " xacc:" + this.xacc + " yacc:" + this.yacc + " zacc:" + this.zacc + " xgyro:" + this.xgyro + " ygyro:" + this.ygyro + " zgyro:" + this.zgyro + " lat:" + this.lat + " lon:" + this.lon + " alt:" + this.alt + " std_dev_horz:" + this.std_dev_horz + " std_dev_vert:" + this.std_dev_vert + " vn:" + this.f8354vn + " ve:" + this.f8353ve + " vd:" + this.f8352vd + "";
    }
}
