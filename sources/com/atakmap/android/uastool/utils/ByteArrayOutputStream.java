...
public class ByteArrayOutputStream extends OutputStream {
    ...
    private ByteArrayOutputStream(int i) {
    ...
    private synchronized int write(InputStream inputStream) {
        int i;
    ...
    private synchronized byte[] toByteArray() {
        ...
        L_0x002d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.atakmap.android.uastool.utils.ByteArrayOutputStream.toByteArray():byte[]");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized byte[] toByteArray(byte[] r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            int r0 = r6.count     // Catch:{ all -> 0x002b }
            if (r0 != 0) goto L_0x0009
            byte[] r7 = EMPTY_BYTE_ARRAY     // Catch:{ all -> 0x002b }
            monitor-exit(r6)
            return r7
        L_0x0009:
            java.util.List<byte[]> r1 = r6.buffers     // Catch:{ all -> 0x002b }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ all -> 0x002b }
            r2 = 0
            r3 = 0
        L_0x0011:
            boolean r4 = r1.hasNext()     // Catch:{ all -> 0x002b }
            if (r4 == 0) goto L_0x0029
            java.lang.Object r4 = r1.next()     // Catch:{ all -> 0x002b }
            byte[] r4 = (byte[]) r4     // Catch:{ all -> 0x002b }
            int r5 = r4.length     // Catch:{ all -> 0x002b }
            int r5 = java.lang.Math.min(r5, r0)     // Catch:{ all -> 0x002b }
            java.lang.System.arraycopy(r4, r2, r7, r3, r5)     // Catch:{ all -> 0x002b }
            int r3 = r3 + r5
            int r0 = r0 - r5
        ...
        L_0x002b:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.atakmap.android.uastool.utils.ByteArrayOutputStream.toByteArray(byte[]):byte[]");
    }
