package com.autel.camera.protocol.protocol20.interfaces.xb008;
...
public interface CameraXb08 extends BaseCameraService {
    ...
    void getCameraAperture(CallbackWithOneParam<CameraAperture> callbackWithOneParam);

    void getCameraAutoExposureState(CallbackWithOneParam<CameraAllSettings.AELock> callbackWithOneParam);

    void getCameraFocus(CallbackWithOneParam<CameraAllSettings.Focus> callbackWithOneParam);
    ...
    void setCameraAperture(CameraAperture cameraAperture, CallbackWithNoParam callbackWithNoParam);
    ...
    void setFocusAFSpotArea(int i, int i2, CallbackWithNoParam callbackWithNoParam);
    ...
    void setManualFocusDistance(int i, CallbackWithNoParam callbackWithNoParam);
