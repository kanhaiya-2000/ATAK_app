...
/* renamed from: com.autel.camera.protocol.protocol20.xt706.XT706 */
public class C2568XT706 extends BaseCamera20 implements CameraXT706 {
    ...
    public void getDisplayMode(final CallbackWithOneParam<DisplayMode> callbackWithOneParam) {
        this.request.getDisplayMode(new CallbackWithOneParam<CameraAllSettings.DisplayMode>() {
    ...
    public void getIrColor(final CallbackWithOneParam<IrColor> callbackWithOneParam) {
        this.request.getIrColor(new CallbackWithOneParam<CameraAllSettings.IrColor>() {
    ...
    public void getIrPosition(final CallbackWithOneParam<IrPosition> callbackWithOneParam) {
        this.request.getIrPosition(new CallbackWithOneParam<CameraAllSettings.IrPosition>() {
