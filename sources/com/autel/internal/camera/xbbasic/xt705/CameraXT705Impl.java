...
import com.autel.camera.protocol.protocol20.xt705.C2508XT705;
...
import com.autel.common.camera.XT705.XT705StateInfo;
...
public class CameraXT705Impl extends BaseCamera20 implements CameraXT705Service {
    private static final String MediaInfoTag = "MediaInfo";
    protected XT705ParameterRangeManager XT705ParameterRangeManager;
    final AtomicBoolean hasCallback = new AtomicBoolean(false);
    /* access modifiers changed from: private */
    public CameraSkylineCalculator mCameraSkylineCalculator;
    protected CameraXT705 request = ((CameraXT705) CameraFactory.getCameraProduct(C2508XT705.class));
    /* access modifiers changed from: private */
    ...
    public void setCameraAperture(CameraAperture cameraAperture, CallbackWithNoParam callbackWithNoParam) {
        this.request.setCameraAperture(cameraAperture, callbackWithNoParam);
    }

    public void getCameraAperture(CallbackWithOneParam<CameraAperture> callbackWithOneParam) {
        if (callbackWithOneParam != null) {
            this.request.getCameraAperture(callbackWithOneParam);
        }
    }
    ...
    public void getStateInfo(final CallbackWithOneParam<BaseStateInfo> callbackWithOneParam) {
        if (CameraManager.instance().isParameterValid()) {
            callbackWithOneParam.onSuccess(new XT705StateInfo() {
                ...
                public PhotoAspectRatio getPhotoAspectRatio() {
                    return PhotoAspectRatio.find(CameraXB015Data.instance().getPicResolution(), CameraProduct.XT705);
                }
                ...
                public ISOMode getISOMode() {
                    return ISOMode.find(CameraXB015Data.instance().getISOMode());
                }

                public CameraProduct getType() {
                    return CameraProduct.XT705;
                }
            ...
            this.request.getCameraAllSetting(CameraAllSettings.class, new CallbackWithOneParam<CameraAllSettings>() {
                public void onSuccess(final CameraAllSettings cameraAllSettings) {
                    ...
                    C34611 r0 = new XT705StateInfo() {
                        ...
                        public PhotoAspectRatio getPhotoAspectRatio() {
                            return PhotoAspectRatio.find(cameraAllSettings.getPhotoTakingSettings().getResolution(), CameraProduct.XT705);
                        }
                        ...
                        public ISOMode getISOMode() {
                            if (cameraAllSettings.getIsoMode() != null) {
                                return ISOMode.find(cameraAllSettings.getIsoMode().getMode());
                            }
                            return ISOMode.UNKNOWN;
                        }
                    ...
                    CameraXT705Impl.this.hasCallback.set(false);
    ...
    public void setAspectRatio(final PhotoAspectRatio photoAspectRatio, final CallbackWithNoParam callbackWithNoParam) {
        this.request.setAspectRatio(photoAspectRatio.value(CameraProduct.XT705), new CallbackWithNoParam() {
            public void onSuccess() {
                CameraXB015Data.instance().setPicResolution(photoAspectRatio.value(CameraProduct.XT705));
        ...
        if (callbackWithOneParam != null) {
            this.request.getPhotoTakingSettings(new CallbackWithOneParam<CameraAllSettings.PhotoTakingSettings>() {
                public void onSuccess(CameraAllSettings.PhotoTakingSettings photoTakingSettings) {
                    callbackWithOneParam.onSuccess(PhotoAspectRatio.find(photoTakingSettings.getResolution(), CameraProduct.XT705));
                }
    ...
    public void getVideoRotation(final CallbackWithOneParam<VideoRotation> callbackWithOneParam) {
        CameraXT705 cameraXT705 = this.request;
        if (cameraXT705 != null) {
            cameraXT705.getVideoSourceConfiguration(new CallbackWithOneParam<CameraAllSettings.VideoSourceConfiguration>() {
    ...
    public void getSkylinePositionData(final int i, final int i2, final CallbackWithOneParam<SkylinePositionData> callbackWithOneParam) {
            ...
            getVideoResolutionAndFrameRate(new CallbackWithOneParam<VideoResolutionAndFps>() {
                ...
                public void onSuccess(VideoResolutionAndFps videoResolutionAndFps) {
                    ...
                    if (MediaMode.find(CameraXB015Data.instance().getCameraMode()) == MediaMode.UNKNOWN) {
                        CameraXT705Impl.this.getMediaMode(new CallbackWithOneParam<MediaMode>() {
                            public void onFailure(AutelError autelError) {
                            }

                            public void onSuccess(MediaMode mediaMode) {
                                CameraXT705Impl.this.skylinePositionData.skylineYPosition = CameraXT705Impl.this.mCameraSkylineCalculator.getSkylineYInView(videoResolution, i2, i);
                                CameraXT705Impl.this.skylinePositionData.heightDistanceBetweenSkylineAndValidBoundary = CameraXT705Impl.this.mCameraSkylineCalculator.getValidBoundaryDistanceInView(i);
                                callbackWithOneParam.onSuccess(CameraXT705Impl.this.skylinePositionData);
                            }
                        });
                        return;
                    }
        ...
        if (MediaMode.find(CameraXB015Data.instance().getCameraMode()) == MediaMode.UNKNOWN) {
            ...
            getMediaMode(new CallbackWithOneParam<MediaMode>() {
                ...
                public void onSuccess(MediaMode mediaMode) {
                    CameraXT705Impl.this.skylinePositionData.skylineYPosition = CameraXT705Impl.this.mCameraSkylineCalculator.getSkylineYInView(videoResolution, i3, i4);
                    CameraXT705Impl.this.skylinePositionData.heightDistanceBetweenSkylineAndValidBoundary = CameraXT705Impl.this.mCameraSkylineCalculator.getValidBoundaryDistanceInView(i4);
                    callbackWithOneParam2.onSuccess(CameraXT705Impl.this.skylinePositionData);
                }
            });
            return;
        }
        ...
        if (callbackWithOneParam != null) {
            ...
            BaseCameraRequest.instance().addCameraSystemStatusListener("setFMCameraSystemStatusListener", new CallbackWithOneParam<CameraSystemStatus>() {
                ...
                public void onSuccess(CameraSystemStatus cameraSystemStatus) {
                    if (CameraXT705Impl.this.sdCardStatus != null && !CameraXT705Impl.this.sdCardStatus.equalsIgnoreCase(cameraSystemStatus.getMMCStatus())) {
                        String unused = CameraXT705Impl.this.sdCardStatus = cameraSystemStatus.getMMCStatus();
    ...
    public void setInfoListener(final CallbackWithOneParam<XT705CameraInfo> callbackWithOneParam) {
        if (callbackWithOneParam == null) {
            ...
            this.request.addCameraSystemStatusListener(MediaInfoTag, new CallbackWithOneParam<CameraSystemStatus>() {
                public void onSuccess(final CameraSystemStatus cameraSystemStatus) {
                    callbackWithOneParam.onSuccess(new XT705CameraInfo() {
    ...
    public void getISOMode(CallbackWithOneParam<ISOMode> callbackWithOneParam) {
        this.request.getISOMode(callbackWithOneParam);
    }

    public XT705ParameterRangeManager getParameterRangeManager() {
        if (this.XT705ParameterRangeManager == null) {
            this.XT705ParameterRangeManager = new XT705ParameterRangeManagerImpl();
        }
        return this.XT705ParameterRangeManager;
    }
}
