...
public class CameraXT705PreconditionProxy extends BaseCamera20PreconditionProxy implements CameraXT705Service {
    private CameraXT705Service cameraXt701Service;
    ...
    public CameraXT705PreconditionProxy(CameraXT705Service cameraXT705Service) {
        super(cameraXT705Service);
        this.cameraXt701Service = cameraXT705Service;
    }
    ...
    public void setCameraAperture(CameraAperture cameraAperture, CallbackWithNoParam callbackWithNoParam) {
        if (cameraAperture != null) {
            this.cameraXt701Service.setCameraAperture(cameraAperture, callbackWithNoParam);
    ...
    public void getCameraAperture(CallbackWithOneParam<CameraAperture> callbackWithOneParam) {
        if (callbackWithOneParam != null) {
            this.cameraXt701Service.getCameraAperture(callbackWithOneParam);
        }
    }
    ...
    public void setSpotMeteringArea(int i, int i2, CallbackWithNoParam callbackWithNoParam) {
        XT705ParameterRangeManager parameterRangeManager = getParameterRangeManager();
    ...
    public void setVideoResolutionAndFrameRate(VideoResolutionAndFps videoResolutionAndFps, CallbackWithNoParam callbackWithNoParam) {
        ...
        } else if (ResolutionFpsSupportUtil.isSupport(CameraProduct.XT705, videoResolutionAndFps.resolution, videoResolutionAndFps.fps)) {
    ...
    public void setHDREnable(boolean z, CallbackWithNoParam callbackWithNoParam) {
        ...
        } else if ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_60ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_50ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_48ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_30ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_25ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_3840x2160 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_24ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_60ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_50ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_48ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_30ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_25ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_2720x1528 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_24ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_60ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_50ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_48ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_30ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_25ps) || ((videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1920x1080 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_24ps) || (videoMainResolutionAndFps.resolution == VideoResolution.Resolution_1280x720 && videoMainResolutionAndFps.fps == VideoFps.FrameRate_120ps))))))))))))))))))) {
            this.cameraXt701Service.setHDREnable(z, callbackWithNoParam);
        } else {
    ...
    public void setISOMode(ISOMode iSOMode, CallbackWithNoParam callbackWithNoParam) {
        this.cameraXt701Service.setISOMode(iSOMode, callbackWithNoParam);
    }

    public void getISOMode(CallbackWithOneParam<ISOMode> callbackWithOneParam) {
        this.cameraXt701Service.getISOMode(callbackWithOneParam);
    }
