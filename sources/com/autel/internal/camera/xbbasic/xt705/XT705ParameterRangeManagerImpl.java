...
public class XT705ParameterRangeManagerImpl implements XT705ParameterRangeManager {
    ...
    public CameraISO[] getCameraISO() {
        if (MediaMode.VIDEO == MediaMode.find(CameraXB015Data.instance().getCameraMode())) {
        ...
        return new CameraISO[]{CameraISO.ISO_100, CameraISO.ISO_200, CameraISO.ISO_400, CameraISO.ISO_800, CameraISO.ISO_1600, CameraISO.ISO_3200, CameraISO.ISO_6400, CameraISO.ISO_12800};
    }

    public VideoResolutionAndFps[] getVideoResolutionAndFps() {
        return ResolutionFpsSupportUtil.Support(CameraProduct.XT705);
    }
    ...
    public PhotoAspectRatio[] getPhotoAspectRatio() {
        ...
        return new PhotoAspectRatio[]{PhotoAspectRatio.Aspect_3_2, PhotoAspectRatio.Aspect_16_9, PhotoAspectRatio.Aspect_16_9_HDR};
    }
    ...
    public List<PhotoTimelapseInterval> getPhotoTimelapseInterval() {
        ...
        if (find2 == ExposureMode.Manual || find2 == ExposureMode.ShutterPriority) {
            ...
            float f = 0.0f;
            int i = C365911.$SwitchMap$com$autel$common$camera$base$PhotoFormat[find.ordinal()];
            if (i == 1) {
                f = 1.5f;
            } else if (i == 2) {
                f = 2.0f;
    ...
    /* renamed from: com.autel.internal.camera.xbbasic.xt705.XT705ParameterRangeManagerImpl$11 */
    /* synthetic */ class C365911 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.autel.internal.camera.xbbasic.xt705.XT705ParameterRangeManagerImpl.C365911.<clinit>():void");
        }
    }
    ...
    public CameraAperture[] getCameraAperture() {
        return new CameraAperture[]{CameraAperture.Aperture_2p8, CameraAperture.Aperture_3p2, CameraAperture.Aperture_3p5, CameraAperture.Aperture_4p0, CameraAperture.Aperture_4p5, CameraAperture.Aperture_5p0, CameraAperture.Aperture_5p6, CameraAperture.Aperture_6p3, CameraAperture.Aperture_7p1, CameraAperture.Aperture_8p0, CameraAperture.Aperture_9p0, CameraAperture.Aperture_10, CameraAperture.Aperture_11};
    }
}
