...
public class XT706ParameterRangeManagerImpl implements XT706ParameterRangeManager {
    ...
    public CameraISO[] getCameraISO() {
        ...
        String currentMode = CameraXB015Data.instance().getCurrentMode();
        String displayMode = CameraXB015Data.instance().getDisplayMode();
        if (!TextUtils.equals("Record", currentMode) || !TextUtils.equals("Visible", displayMode)) {
    ...
    public VideoResolutionAndFps[] getVideoResolutionAndFps() {
        return ResolutionFpsSupportUtil.SupportXT706(DisplayMode.find(CameraXB015Data.instance().getDisplayMode()));
    }
    ...
    public List<PhotoTimelapseInterval> getPhotoTimelapseInterval() {
        ...
        if (find2 == ExposureMode.Manual || find2 == ExposureMode.ShutterPriority) {
            ...
            float f = 0.0f;
            int i = C393411.$SwitchMap$com$autel$common$camera$base$PhotoFormat[find.ordinal()];
            if (i == 1) {
                f = 1.5f;
            } else if (i == 2) {
                f = 2.0f;
    ...
    /* renamed from: com.autel.internal.camera.xbbasic.xt706.XT706ParameterRangeManagerImpl$11 */
    /* synthetic */ class C393411 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.autel.internal.camera.xbbasic.xt706.XT706ParameterRangeManagerImpl.C393411.<clinit>():void");
        }
    }
