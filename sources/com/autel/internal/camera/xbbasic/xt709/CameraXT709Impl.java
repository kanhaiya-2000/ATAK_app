...
import com.autel.common.camera.xt709.XT709StateInfo;
...
public class CameraXT709Impl extends BaseCamera20 implements CameraXT709Service {
        ...
        if (this.hasCallback.compareAndSet(false, true)) {
            this.cameraRequest.getCameraAllSetting(CameraAllSettings.class, new CallbackWithOneParam<CameraAllSettings>() {
                public void onSuccess(final CameraAllSettings cameraAllSettings) {
                    ...
                    CameraXT709Impl.this.hasCallback.set(false);
    ...
    public void getSkylinePositionData(final int i, final int i2, final CallbackWithOneParam<SkylinePositionData> callbackWithOneParam) {
            ...
            getVideoResolutionAndFrameRate(new CallbackWithOneParam<VideoResolutionAndFps>() {
                ...
                public void onSuccess(VideoResolutionAndFps videoResolutionAndFps) {
                    ...
                    if (MediaMode.find(CameraXB015Data.instance().getCameraMode()) == MediaMode.UNKNOWN) {
                        CameraXT709Impl.this.getMediaMode(new CallbackWithOneParam<MediaMode>() {
                            public void onFailure(AutelError autelError) {
                            }

                            public void onSuccess(MediaMode mediaMode) {
                                CameraXT709Impl.this.skylinePositionData.skylineYPosition = CameraXT709Impl.this.mCameraSkylineCalculator.getSkylineYInView(videoResolution, i2, i);
                                CameraXT709Impl.this.skylinePositionData.heightDistanceBetweenSkylineAndValidBoundary = CameraXT709Impl.this.mCameraSkylineCalculator.getValidBoundaryDistanceInView(i);
                                callbackWithOneParam.onSuccess(CameraXT709Impl.this.skylinePositionData);
                            }
                        });
                        return;
                    }
        ...
        if (MediaMode.find(CameraXB015Data.instance().getCameraMode()) == MediaMode.UNKNOWN) {
            ...
            getMediaMode(new CallbackWithOneParam<MediaMode>() {
                ...
                public void onSuccess(MediaMode mediaMode) {
                    CameraXT709Impl.this.skylinePositionData.skylineYPosition = CameraXT709Impl.this.mCameraSkylineCalculator.getSkylineYInView(videoResolution, i3, i4);
                    CameraXT709Impl.this.skylinePositionData.heightDistanceBetweenSkylineAndValidBoundary = CameraXT709Impl.this.mCameraSkylineCalculator.getValidBoundaryDistanceInView(i4);
                    callbackWithOneParam2.onSuccess(CameraXT709Impl.this.skylinePositionData);
                }
            });
            return;
        }
    ...
    public void setIrImageMode(ImageMode imageMode, int i, int i2, CallbackWithNoParam callbackWithNoParam) {
        this.httpRequest.setIrImageMode(imageMode, i, i2, callbackWithNoParam);
    }

    public void getIrImageMode(final CallbackWithOneParam<IrImageModeParam> callbackWithOneParam) {
        this.httpRequest.getIrImageMode(new CallbackWithOneParam<BaseCameraMsgParser>() {
            public void onFailure(AutelError autelError) {
                CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                if (callbackWithOneParam != null) {
                    callbackWithOneParam.onFailure(autelError);
            ...
            public void onSuccess(BaseCameraMsgParser baseCameraMsgParser) {
                if (callbackWithOneParam != null) {
                    IrImageModeParam irImageModeParam = new IrImageModeParam();
                    try {
                        JSONObject jSONObject = new JSONObject(baseCameraMsgParser.getParam("result"));
                        irImageModeParam.imageMode = ImageMode.find(jSONObject.getInt(CameraParamsConfig.param_ImageMode));
                        irImageModeParam.brightness = jSONObject.getInt(CameraParamsConfig.param_Lum);
                        irImageModeParam.contrast = jSONObject.getInt(CameraParamsConfig.param_Contrast);
                        callbackWithOneParam.onSuccess(irImageModeParam);
    ...
    public void setIrEnhance(boolean z, int i, CallbackWithNoParam callbackWithNoParam) {
        this.httpRequest.setIrEnhance(z, i, callbackWithNoParam);
    }

    public void getIrEnhance(final CallbackWithOneParam<IrEnhanceParam> callbackWithOneParam) {
        this.httpRequest.getIrEnhance(new CallbackWithOneParam<BaseCameraMsgParser>() {
            public void onFailure(AutelError autelError) {
                CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                if (callbackWithOneParam != null) {
                    callbackWithOneParam.onFailure(autelError);
            ...
            public void onSuccess(BaseCameraMsgParser baseCameraMsgParser) {
                if (callbackWithOneParam != null) {
                    try {
                        JSONObject jSONObject = new JSONObject(baseCameraMsgParser.getParam("result"));
                        IrEnhanceParam irEnhanceParam = new IrEnhanceParam();
                        boolean z = true;
                        if (jSONObject.getInt(CameraParamsConfig.param_Enable) != 1) {
                            z = false;
                        }
                        irEnhanceParam.enable = z;
                        irEnhanceParam.strength = jSONObject.getInt(CameraParamsConfig.param_Strength);
                        callbackWithOneParam.onSuccess(irEnhanceParam);
                    } catch (JSONException e) {
                        e.printStackTrace();
                        CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                        if (callbackWithOneParam != null) {
    ...
    public void setIrDeNoise(boolean z, CallbackWithNoParam callbackWithNoParam) {
        this.httpRequest.setIrDeNoise(z, callbackWithNoParam);
    }

    public void getIrDeNoise(final CallbackWithOneParam<Boolean> callbackWithOneParam) {
        this.httpRequest.getIrDeNoise(new CallbackWithOneParam<BaseCameraMsgParser>() {
            public void onFailure(AutelError autelError) {
                CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                if (callbackWithOneParam != null) {
                    callbackWithOneParam.onFailure(autelError);
    ...
    public void setIrGain(IrGainMode irGainMode, CallbackWithNoParam callbackWithNoParam) {
        this.httpRequest.setIrGain(irGainMode, callbackWithNoParam);
    }

    public void getIrGain(final CallbackWithOneParam<IrGainMode> callbackWithOneParam) {
        this.httpRequest.getIrGain(new CallbackWithOneParam<BaseCameraMsgParser>() {
            public void onFailure(AutelError autelError) {
                CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                if (callbackWithOneParam != null) {
                    callbackWithOneParam.onFailure(autelError);
            ...
            public void onSuccess(BaseCameraMsgParser baseCameraMsgParser) {
                if (callbackWithOneParam != null) {
                    try {
                        callbackWithOneParam.onSuccess(IrGainMode.find(new JSONObject(baseCameraMsgParser.getParam("result")).getInt(CameraParamsConfig.param_Gain)));
                    } catch (JSONException e) {
                        e.printStackTrace();
                        CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                        if (callbackWithOneParam != null) {
    ...
    public void setIrIsoTherm(IrIsoThermMode irIsoThermMode, int i, int i2, CallbackWithNoParam callbackWithNoParam) {
        this.httpRequest.setIrIsoTherm(irIsoThermMode, i, i2, callbackWithNoParam);
    }

    public void getIrIsoTherm(final CallbackWithOneParam<IrThresholdParam> callbackWithOneParam) {
        this.httpRequest.getIrIsoTherm(new CallbackWithOneParam<BaseCameraMsgParser>() {
            public void onFailure(AutelError autelError) {
                CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                if (callbackWithOneParam != null) {
                    callbackWithOneParam.onFailure(autelError);
            ...
            public void onSuccess(BaseCameraMsgParser baseCameraMsgParser) {
                if (callbackWithOneParam != null) {
                    try {
                        JSONObject jSONObject = new JSONObject(baseCameraMsgParser.getParam("result"));
                        IrThresholdParam irThresholdParam = new IrThresholdParam();
                        irThresholdParam.mode = IrIsoThermMode.find(jSONObject.getInt("Mode"));
                        irThresholdParam.highTemperature = jSONObject.getInt(CameraParamsConfig.param_HotThred) / 10;
                        irThresholdParam.lowTemperature = jSONObject.getInt(CameraParamsConfig.param_ColdThred) / 10;
                        callbackWithOneParam.onSuccess(irThresholdParam);
                    } catch (JSONException e) {
                        e.printStackTrace();
                        CallbackWithOneParam callbackWithOneParam = callbackWithOneParam;
                        if (callbackWithOneParam != null) {
        ...
        if (callbackWithOneParam != null) {
            ...
            BaseCameraRequest.instance().addCameraSystemStatusListener("setFMCameraSystemStatusListener", new CallbackWithOneParam<CameraSystemStatus>() {
                ...
                public void onSuccess(CameraSystemStatus cameraSystemStatus) {
                    if (!CameraXT709Impl.this.sdCardStatus.equalsIgnoreCase(cameraSystemStatus.getMMCStatus())) {
                        String unused = CameraXT709Impl.this.sdCardStatus = cameraSystemStatus.getSDCardStatus();
        ...
        if (callbackWithOneParam == null) {
            ...
            this.cameraRequest.addCameraSystemStatusListener(MediaInfoTag, new CallbackWithOneParam<CameraSystemStatus>() {
                public void onSuccess(final CameraSystemStatus cameraSystemStatus) {
                    callbackWithOneParam.onSuccess(new XT709CameraInfo() {
    ...
    public XT706ParameterRangeManager getParameterRangeManager() {
        if (this.XT706ParameterRangeManager == null) {
            this.XT706ParameterRangeManager = new XT709ParameterRangeManagerImpl();
        }
