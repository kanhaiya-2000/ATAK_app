...
public class FirmwareInfoFactory {
    ...
    /* renamed from: com.autel.internal.firmware.FirmwareInfoFactory$1 */
    /* synthetic */ class C42651 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.autel.internal.firmware.FirmwareInfoFactory.C42651.<clinit>():void");
        }
    }

    public static FirmwareService createFirmware(AutelServiceVersion autelServiceVersion) {
        int i = C42651.$SwitchMap$com$autel$internal$AutelServiceVersion[autelServiceVersion.ordinal()];
        if (i == 1) {
