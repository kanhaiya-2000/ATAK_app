...
public class RemoteControllerFactory {
    ...
    /* renamed from: com.autel.internal.remotecontroller.RemoteControllerFactory$1 */
    /* synthetic */ class C48491 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.autel.internal.remotecontroller.RemoteControllerFactory.C48491.<clinit>():void");
        }
    }

    public static RemoteControllerService createRemoteController(AutelServiceVersion autelServiceVersion) {
        int i = C48491.$SwitchMap$com$autel$internal$AutelServiceVersion[autelServiceVersion.ordinal()];
        if (i == 1) {
            return new RemoteController10();
        }
        if (i != 2) {
            return new RemoteController10();
        }
        return new RemoteController20();
    }

    public static RemoteControllerService4Initialize createRemoteController() {
        return new RemoteControllerInitializeProxy();
    }
}
