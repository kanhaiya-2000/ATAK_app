...
/* renamed from: com.autel.sdk.camera.rx.RxAutelXT706 */
public interface RxAutelXT706 extends RxAutelBaseCamera {
    ...
    Observable<IrColor> getIrColor();

    Observable<IrPosition> getIrPosition();

    Observable<Integer> getIrTemperatureEmit();

    Observable<IrTemperatureParams> getIrTemperatureParams();

    Observable<IrTemperatureWarnParams> getIrTemperatureWarningParams();
    ...
    Observable<XT706ParameterRangeManager> getParameterRangeManager();
    ...
    Observable<Boolean> setDisplayMode(DisplayMode displayMode);
    ...
    Observable<Boolean> setIrColor(IrColor irColor);

    Observable<Boolean> setIrFlushShutter();

    Observable<Boolean> setIrPosition(IrPosition irPosition);

    Observable<Boolean> setIrTemperatureEmit(int i);

    Observable<Boolean> setIrTemperatureParams(IrTemperatureParams irTemperatureParams);

    Observable<Boolean> setIrTemperatureWarningParams(IrTemperatureWarnParams irTemperatureWarnParams);
