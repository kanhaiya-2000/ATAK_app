...
public class AutelMD5Util {
    ...
    static {
        ...
        try {
            ...
            printStream.println(AutelMD5Util.class.getName() + "初始化失败，MessageDigest不支持MD5Util。");
            e.printStackTrace();
        }
    }
    ...
    public static java.lang.String getFileMD5(java.io.File r4) {
        ...
        L_0x007b:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autel.sdk10.AutelCommunity.utils.AutelMD5Util.getFileMD5(java.io.File):java.lang.String");
    }
