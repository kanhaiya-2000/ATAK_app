...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m15096is(char c) {
        return new C5116Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m15096is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo20022or(CharMatcher charMatcher) {
        return new C5117Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m15096is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C5117Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C5117Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C5116Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo20022or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo20022or(charMatcher);
        }
