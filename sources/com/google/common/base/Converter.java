...
public abstract class Converter<A, B> implements Function<A, B> {
    ...
    @cij
    public final B convert(@cij A a) {
        return correctedDoForward(a);
    }

    /* access modifiers changed from: package-private */
    @cij
    public B correctedDoForward(@cij A a) {
    ...
    /* access modifiers changed from: package-private */
    @cij
    public A correctedDoBackward(@cij B b) {
        if (!this.handleNullAutomatically) {
            return doBackward(b);
        }
        if (b == null) {
    ...
    private static final class ReverseConverter<A, B> extends Converter<B, A> implements Serializable {
        ...
        /* access modifiers changed from: package-private */
        @cij
        public A correctedDoForward(@cij B b) {
            return this.original.correctedDoBackward(b);
        }

        /* access modifiers changed from: package-private */
        @cij
        public B correctedDoBackward(@cij A a) {
    ...
    private static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable {
        ...
        /* access modifiers changed from: package-private */
        @cij
        public C correctedDoForward(@cij A a) {
            return this.second.correctedDoForward(this.first.correctedDoForward(a));
        }

        /* access modifiers changed from: package-private */
        @cij
        public A correctedDoBackward(@cij C c) {
