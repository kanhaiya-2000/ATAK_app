...
final class Platform {
    ...
    static String nullToEmpty(@cij String str) {
        return str == null ? "" : str;
    }
    ...
    static <T extends Enum<T>> Optional<T> getEnumIfPresent(Class<T> cls, String str) {
        ...
        return weakReference == null ? Optional.absent() : Optional.m15104of(cls.cast(weakReference.get()));
    }
    ...
    static boolean stringIsNullOrEmpty(@cij String str) {
        return str == null || str.isEmpty();
    }

    static String emptyToNull(@cij String str) {
