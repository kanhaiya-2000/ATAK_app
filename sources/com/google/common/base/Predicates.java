...
public final class Predicates {
    ...
    enum ObjectPredicate implements Predicate<Object> {
        ALWAYS_TRUE {
            public boolean apply(@cij Object obj) {
                return true;
            }
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m15110or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m15111or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m15109or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    public static <T> Predicate<T> equalTo(@cij T t) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m15108in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f8530f;

        /* renamed from: p */
        final Predicate<B> f8531p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f8531p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f8530f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@cij A a) {
            return this.f8531p.apply(this.f8530f.apply(a));
        }
        ...
        public boolean equals(@cij Object obj) {
            ...
            if (!this.f8530f.equals(compositionPredicate.f8530f) || !this.f8531p.equals(compositionPredicate.f8531p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f8530f.hashCode() ^ this.f8531p.hashCode();
        }

        public String toString() {
            return this.f8531p + "(" + this.f8530f + ")";
        }
    }
