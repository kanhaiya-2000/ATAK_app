...
public final class Strings {
    ...
    public static String nullToEmpty(@cij String str) {
        return Platform.nullToEmpty(str);
    }

    @cij
    public static String emptyToNull(@cij String str) {
        return Platform.emptyToNull(str);
    }

    public static boolean isNullOrEmpty(@cij String str) {
    ...
    public static String lenientFormat(@cij String str, @cij Object... objArr) {
        int indexOf;
    ...
    private static String lenientToString(@cij Object obj) {
        try {
