...
public final class Throwables {
    ...
    @Deprecated
    public static <X extends Throwable> void propagateIfInstanceOf(@cij Throwable th, Class<X> cls) {
        if (th != null) {
    ...
    @Deprecated
    public static void propagateIfPossible(@cij Throwable th) {
        if (th != null) {
            throwIfUnchecked(th);
        }
    }

    public static <X extends Throwable> void propagateIfPossible(@cij Throwable th, Class<X> cls) {
        propagateIfInstanceOf(th, cls);
        propagateIfPossible(th);
    }

    public static <X1 extends Throwable, X2 extends Throwable> void propagateIfPossible(@cij Throwable th, Class<X1> cls, Class<X2> cls2) {
