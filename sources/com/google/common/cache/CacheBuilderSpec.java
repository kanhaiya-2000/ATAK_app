...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m15115on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m15115on('=').trimResults();
    ...
    private interface ValueParser {
        void parse(CacheBuilderSpec cacheBuilderSpec, String str, @cij String str2);
    }
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C51491.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C51491.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    /* synthetic */ class C51491 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.CacheBuilderSpec.C51491.<clinit>():void");
        }
    }
    ...
    @cij
    private static Long durationInNanos(long j, @cij TimeUnit timeUnit) {
        if (timeUnit == null) {
            return null;
        }
    ...
    static class KeyStrengthParser implements ValueParser {
        ...
        public void parse(CacheBuilderSpec cacheBuilderSpec, String str, @cij String str2) {
            boolean z = true;
