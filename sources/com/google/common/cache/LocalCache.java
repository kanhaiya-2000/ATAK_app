...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final ValueReference<Object, Object> UNSET = new ValueReference<Object, Object>() {
        public ValueReference<Object, Object> copyFor(ReferenceQueue<Object> referenceQueue, @cij Object obj, ReferenceEntry<Object, Object> referenceEntry) {
            return this;
        }
    ...
    interface ValueReference<K, V> {
        ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, @cij V v, ReferenceEntry<K, V> referenceEntry);
    ...
    LocalCache(CacheBuilder<? super K, ? super V> cacheBuilder, @cij CacheLoader<? super K, V> cacheLoader) {
    ...
    enum EntryFactory {
        STRONG {
            /* access modifiers changed from: package-private */
            public <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
        ...
        /* access modifiers changed from: package-private */
        public abstract <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k, int i, @cij ReferenceEntry<K, V> referenceEntry);
    ...
    static class StrongEntry<K, V> extends AbstractReferenceEntry<K, V> {
        ...
        StrongEntry(K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
            this.key = k;
            this.hash = i;
    ...
    static final class StrongWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        volatile long writeTime = bfu.f2629b;

        StrongWriteEntry(K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
            super(k, i, referenceEntry);
        }
    ...
    static final class StrongAccessWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessWriteEntry(K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
            super(k, i, referenceEntry);
        }
    ...
    static class WeakEntry<K, V> extends WeakReference<K> implements ReferenceEntry<K, V> {
        ...
        WeakEntry(ReferenceQueue<K> referenceQueue, K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakAccessEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessEntry(ReferenceQueue<K> referenceQueue, K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakWriteEntry(ReferenceQueue<K> referenceQueue, K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k, i, referenceEntry);
        }
    ...
    static final class WeakAccessWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessWriteEntry(ReferenceQueue<K> referenceQueue, K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k, i, referenceEntry);
        }
    ...
    /* access modifiers changed from: package-private */
    public ReferenceEntry<K, V> newEntry(K k, int i, @cij ReferenceEntry<K, V> referenceEntry) {
    ...
    /* access modifiers changed from: package-private */
    public int hash(@cij Object obj) {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* access modifiers changed from: package-private */
        public void enqueueNotification(@cij K k, int i, @cij V v, int i2, RemovalCause removalCause) {
        ...
        /* access modifiers changed from: package-private */
        @cij
        public ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, @cij K k, int i, V v, ValueReference<K, V> valueReference, RemovalCause removalCause) {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, @cij V v, ReferenceEntry<K, V> referenceEntry) {
            return this;
        }
        ...
        public void notifyNewValue(@cij V v) {
            if (v != null) {
                set(v);
            } else {
    ...
    @cij
    public V getOrDefault(@cij Object obj, @cij V v) {
        V v2 = get(obj);
        return v2 != null ? v2 : v;
    }
    ...
    /* access modifiers changed from: package-private */
    public ReferenceEntry<K, V> getEntry(@cij Object obj) {
        if (obj == null) {
            return null;
        }
        int hash = hash(obj);
