...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    /* access modifiers changed from: package-private */
    public Collection<V> createCollection(@cij K k) {
    ...
    private Collection<V> getOrCreateCollection(@cij K k) {
    ...
    public Collection<V> get(@cij K k) {
        Collection collection = this.map.get(k);
        if (collection == null) {
    ...
    /* access modifiers changed from: package-private */
    public Collection<V> wrapCollection(@cij K k, Collection<V> collection) {
        return new WrappedCollection(k, collection, (AbstractMapBasedMultimap<K, V>.WrappedCollection) null);
    }

    /* access modifiers changed from: package-private */
    public final List<V> wrapList(@cij K k, List<V> list, @cij AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    class WrappedCollection extends AbstractCollection<V> {
        ...
        WrappedCollection(K k, @cij Collection<V> collection, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        WrappedSortedSet(K k, @cij SortedSet<V> sortedSet, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        WrappedNavigableSet(K k, @cij NavigableSet<V> navigableSet, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        WrappedList(K k, @cij List<V> list, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    private class RandomAccessWrappedList extends AbstractMapBasedMultimap<K, V>.WrappedList implements RandomAccess {
        RandomAccessWrappedList(K k, @cij List<V> list, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
            super(k, list, wrappedCollection);
        }
    }
