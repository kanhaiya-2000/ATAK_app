...
abstract class AbstractMapBasedMultiset<E> extends AbstractMultiset<E> implements Serializable {
    ...
    public final int count(@cij Object obj) {
        return this.backingMap.get(obj);
    }

    public final int add(@cij E e, int i) {
        if (i == 0) {
            return count(e);
        }
        boolean z = true;
    ...
    public final int remove(@cij Object obj, int i) {
        if (i == 0) {
            return count(obj);
        }
        Preconditions.checkArgument(i > 0, "occurrences cannot be negative: %s", i);
    ...
    public final int setCount(@cij E e, int i) {
    ...
    public final boolean setCount(@cij E e, int i, int i2) {
