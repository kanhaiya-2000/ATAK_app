...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public V get(@cij Object obj, @cij Object obj2) {
        ...
        return mo20913at(num.intValue(), num2.intValue());
    }
    ...
    public V erase(@cij Object obj, @cij Object obj2) {
        Integer num = this.rowKeyToIndex.get(obj);
        Integer num2 = this.columnKeyToIndex.get(obj2);
        if (num == null || num2 == null) {
            return null;
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) {
            ...
            public V getValue() {
                return ArrayTable.this.mo20913at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return mo20913at(i / this.columnList.size(), i % this.columnList.size());
    }

    public Map<R, V> column(C c) {
        Preconditions.checkNotNull(c);
        Integer num = this.columnKeyToIndex.get(c);
        return num == null ? ImmutableMap.m15152of() : new Column(num.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int i) {
            return ArrayTable.this.mo20913at(i, this.columnIndex);
        }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m15152of() : new Row(num.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int i) {
            return ArrayTable.this.mo20913at(this.rowIndex, i);
        }
