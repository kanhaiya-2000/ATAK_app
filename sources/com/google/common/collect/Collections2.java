...
public final class Collections2 {
    ...
    static boolean safeContains(Collection<?> collection, @cij Object obj) {
    ...
    static boolean safeRemove(Collection<?> collection, @cij Object obj) {
        Preconditions.checkNotNull(collection);
        try {
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                ...
                while (true) {
                    ...
                    int i2 = this.f8549j;
                    int i3 = iArr[i2] + this.f8550o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
                        Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                        this.f8548c[this.f8549j] = i3;
                        return;
                    } else if (i2 != 0) {
                        i++;
                        switchDirection();
