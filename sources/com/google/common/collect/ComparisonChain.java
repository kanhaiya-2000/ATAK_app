...
public abstract class ComparisonChain {
    ...
    public static final ComparisonChain ACTIVE = new ComparisonChain() {
        ...
        public <T> ComparisonChain compare(@cij T t, @cij T t2, Comparator<T> comparator) {
    ...
    public abstract <T> ComparisonChain compare(@cij T t, @cij T t2, Comparator<T> comparator);
    ...
    private static final class InactiveComparisonChain extends ComparisonChain {
        ...
        public ComparisonChain compare(@cij Comparable comparable, @cij Comparable comparable2) {
            return this;
        }

        public <T> ComparisonChain compare(@cij T t, @cij T t2, @cij Comparator<T> comparator) {
            return this;
        }
