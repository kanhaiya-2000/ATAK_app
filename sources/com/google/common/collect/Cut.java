...
abstract class Cut<C extends Comparable> implements Serializable, Comparable<Cut<C>> {
    ...
    private static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = C52051.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
            if (i == 1) {
                return this;
            }
            if (i == 2) {
    ...
    /* synthetic */ class C52051 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Cut.C52051.<clinit>():void");
        }
    }
