...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo19988or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m15123of() {
        return from(ImmutableList.m15133of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m15124of(@cij E e, E... eArr) {
    ...
    public final boolean contains(@cij Object obj) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m15104of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m15104of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m15104of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
