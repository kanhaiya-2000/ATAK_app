...
final class GeneralRange<T> implements Serializable {
    ...
    static <T> GeneralRange<T> downTo(Comparator<? super T> comparator2, @cij T t, BoundType boundType) {
        return new GeneralRange(comparator2, true, t, boundType, false, (T) null, BoundType.OPEN);
    }

    static <T> GeneralRange<T> upTo(Comparator<? super T> comparator2, @cij T t, BoundType boundType) {
        return new GeneralRange(comparator2, false, (Object) null, BoundType.OPEN, true, t, boundType);
    }

    static <T> GeneralRange<T> range(Comparator<? super T> comparator2, @cij T t, BoundType boundType, @cij T t2, BoundType boundType2) {
        return new GeneralRange(comparator2, true, t, boundType, true, t2, boundType2);
    }

    private GeneralRange(Comparator<? super T> comparator2, boolean z, @cij T t, BoundType boundType, boolean z2, @cij T t2, BoundType boundType2) {
    ...
    /* access modifiers changed from: package-private */
    public boolean tooHigh(@cij T t) {
        boolean z = false;
        if (!hasUpperBound()) {
            return false;
        }
    ...
    /* access modifiers changed from: package-private */
    public boolean contains(@cij T t) {
