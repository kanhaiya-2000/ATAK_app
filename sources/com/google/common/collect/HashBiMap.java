...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    /* access modifiers changed from: package-private */
    public int findEntryByKey(@cij Object obj) {
        return findEntryByKey(obj, Hashing.smearedHash(obj));
    }

    /* access modifiers changed from: package-private */
    public int findEntryByKey(@cij Object obj, int i) {
        return findEntry(obj, i, this.hashTableKToV, this.nextInBucketKToV, this.keys);
    }

    /* access modifiers changed from: package-private */
    public int findEntryByValue(@cij Object obj) {
        return findEntryByValue(obj, Hashing.smearedHash(obj));
    }

    /* access modifiers changed from: package-private */
    public int findEntryByValue(@cij Object obj, int i) {
        return findEntry(obj, i, this.hashTableVToK, this.nextInBucketVToK, this.values);
    }

    /* access modifiers changed from: package-private */
    public int findEntry(@cij Object obj, int i, int[] iArr, int[] iArr2, Object[] objArr) {
    ...
    /* access modifiers changed from: package-private */
    @cij
    public K getInverse(@cij Object obj) {
    ...
    public V put(@cij K k, @cij V v) {
        return put(k, v, false);
    }

    /* access modifiers changed from: package-private */
    @cij
    public V put(@cij K k, @cij V v, boolean z) {
    ...
    /* access modifiers changed from: package-private */
    @cij
    public K putInverse(@cij V v, @cij K k, boolean z) {
    ...
    /* access modifiers changed from: private */
    public void replaceValueInEntry(int i, @cij V v, boolean z) {
        Preconditions.checkArgument(i != -1);
        int smearedHash = Hashing.smearedHash(v);
        int findEntryByValue = findEntryByValue(v, smearedHash);
        if (findEntryByValue != -1) {
    ...
    /* access modifiers changed from: private */
    public void replaceKeyInEntry(int i, @cij K k, boolean z) {
        Preconditions.checkArgument(i != -1);
        int smearedHash = Hashing.smearedHash(k);
        int findEntryByKey = findEntryByKey(k, smearedHash);
    ...
    /* access modifiers changed from: package-private */
    @cij
    public K removeInverse(@cij Object obj) {
        int smearedHash = Hashing.smearedHash(obj);
    ...
    static class Inverse<K, V> extends AbstractMap<V, K> implements BiMap<V, K>, Serializable {
        ...
        @cij
        public K put(@cij V v, @cij K k) {
            return this.forward.putInverse(v, k, false);
        }

        @cij
        public K forcePut(@cij V v, @cij K k) {
        ...
        @cij
        public K remove(@cij Object obj) {
