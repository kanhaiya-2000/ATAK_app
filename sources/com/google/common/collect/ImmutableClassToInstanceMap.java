...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(ImmutableMap.m15152of());
    private final ImmutableMap<Class<? extends B>, B> delegate;

    /* renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m15131of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m15132of(Class<T> cls, T t) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m15153of(cls, t));
    }
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableClassToInstanceMap.m15131of();
            }
