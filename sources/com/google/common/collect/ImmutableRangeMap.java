...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m15133of(), ImmutableList.m15133of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m15171of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m15172of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m15134of(range), ImmutableList.m15134of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() {
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range) {
                ...
                return ImmutableRangeMap.m15171of();
            }
        };
    }
