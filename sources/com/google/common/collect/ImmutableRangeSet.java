...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m15134of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m15133of());
    @LazyInit
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m15173of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m15174of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m15134of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.isEmpty()) {
            ...
            ImmutableRangeSet<C> of = m15173of();
            this.complement = of;
            return of;
        }
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m15213of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m15173of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m15134of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
