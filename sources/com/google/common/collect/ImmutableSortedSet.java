...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements SortedIterable<E>, NavigableSet<E> {
    ...
    /* access modifiers changed from: package-private */
    public abstract int indexOf(@cij Object obj);
    ...
    static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator2) {
        ...
        return new RegularImmutableSortedSet<>(ImmutableList.m15133of(), comparator2);
    }

    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m15213of() {
        return RegularImmutableSortedSet.NATURAL_EMPTY_SET;
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15214of(E e) {
        return new RegularImmutableSortedSet(ImmutableList.m15134of(e), Ordering.natural());
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15215of(E e, E e2) {
        return construct(Ordering.natural(), 2, e, e2);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15216of(E e, E e2, E e3) {
        return construct(Ordering.natural(), 3, e, e2, e3);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15217of(E e, E e2, E e3, E e4) {
        return construct(Ordering.natural(), 4, e, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15218of(E e, E e2, E e3, E e4, E e5) {
        return construct(Ordering.natural(), 5, e, e2, e3, e4, e5);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m15219of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
