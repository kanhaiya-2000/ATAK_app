...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public /* bridge */ /* synthetic */ boolean containsColumn(@cij Object obj) {
        return super.containsColumn(obj);
    }

    public /* bridge */ /* synthetic */ boolean containsRow(@cij Object obj) {
    ...
    public /* bridge */ /* synthetic */ Object get(@cij Object obj, @cij Object obj2) {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m15226of() {
        return SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m15227of(R r, C c, V v) {
    ...
    public static final class Builder<R, C, V> {
        ...
        public ImmutableTable<R, C, V> build() {
            ...
            if (size == 0) {
                return ImmutableTable.m15226of();
            }
            if (size != 1) {
    ...
    public ImmutableMap<R, V> column(C c) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c), ImmutableMap.m15152of());
    }
    ...
    public ImmutableMap<C, V> row(R r) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r), ImmutableMap.m15152of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m15227of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
