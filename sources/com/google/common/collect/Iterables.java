...
public final class Iterables {
    ...
    public static boolean contains(Iterable<?> iterable, @cij Object obj) {
        if (iterable instanceof Collection) {
    ...
    @cij
    public static <T> T getOnlyElement(Iterable<? extends T> iterable, @cij T t) {
    ...
    public static int frequency(Iterable<?> iterable, @cij Object obj) {
    ...
    @cij
    public static <T> T find(Iterable<? extends T> iterable, Predicate<? super T> predicate, @cij T t) {
    ...
    @cij
    public static <T> T get(Iterable<? extends T> iterable, int i, @cij T t) {
        Preconditions.checkNotNull(iterable);
    ...
    @cij
    public static <T> T getFirst(Iterable<? extends T> iterable, @cij T t) {
    ...
    @cij
    public static <T> T getLast(Iterable<? extends T> iterable, @cij T t) {
        if (iterable instanceof Collection) {
