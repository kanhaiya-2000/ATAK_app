...
public final class Iterators {
    ...
    public static boolean contains(Iterator<?> it, @cij Object obj) {
        if (obj == null) {
            while (it.hasNext()) {
                if (it.next() == null) {
                    return true;
    ...
    public static <T> T getOnlyElement(Iterator<T> it) {
        ...
        sb.append(bpg.f3097e);
        throw new IllegalArgumentException(sb.toString());
    }

    @cij
    public static <T> T getOnlyElement(Iterator<? extends T> it, @cij T t) {
    ...
    public static int frequency(Iterator<?> it, @cij Object obj) {
        int i = 0;
    ...
    @cij
    public static <T> T find(Iterator<? extends T> it, Predicate<? super T> predicate, @cij T t) {
        Preconditions.checkNotNull(it);
        Preconditions.checkNotNull(predicate);
        while (it.hasNext()) {
            T next = it.next();
    ...
    @cij
    public static <T> T get(Iterator<? extends T> it, int i, @cij T t) {
        checkNonnegative(i);
        advance(it, i);
        return getNext(it, t);
    }
    ...
    @cij
    public static <T> T getNext(Iterator<? extends T> it, @cij T t) {
    ...
    @cij
    public static <T> T getLast(Iterator<? extends T> it, @cij T t) {
    ...
    public static <T> UnmodifiableIterator<T> singletonIterator(@cij final T t) {
        return new UnmodifiableIterator<T>() {
            boolean done;
