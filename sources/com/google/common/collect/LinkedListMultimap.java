...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    /* access modifiers changed from: private */
    public Node<K, V> addNode(@cij K k, @cij V v, @cij Node<K, V> node) {
    ...
    /* access modifiers changed from: private */
    public void removeAllNodes(@cij Object obj) {
        Iterators.clear(new ValueForKeyIterator(obj));
    }

    /* access modifiers changed from: private */
    public static void checkElement(@cij Object obj) {
        if (obj == null) {
    ...
    private class ValueForKeyIterator implements ListIterator<V> {
        ...
        public ValueForKeyIterator(Object obj, @cij int i) {
            int i2;
            Node<K, V> node;
            Node<K, V> node2;
            KeyList keyList = (KeyList) LinkedListMultimap.this.keyToKeyList.get(obj);
    ...
    public List<V> replaceValues(@cij K k, Iterable<? extends V> iterable) {
    ...
    private List<V> getCopy(@cij Object obj) {
    ...
    public List<V> get(@cij final K k) {
