...
public final class Lists {
    ...
    public static <E> List<E> asList(@cij E e, E[] eArr) {
        return new OnePlusArrayList(e, eArr);
    }

    public static <E> List<E> asList(@cij E e, @cij E e2, E[] eArr) {
    ...
    private static class OnePlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess {
        ...
        OnePlusArrayList(@cij E e, E[] eArr) {
            this.first = e;
    ...
    private static class TwoPlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess {
        ...
        TwoPlusArrayList(@cij E e, @cij E e2, E[] eArr) {
            this.first = e;
            this.second = e2;
            this.rest = (Object[]) Preconditions.checkNotNull(eArr);
        }
    ...
    static boolean equalsImpl(List<?> list, @cij Object obj) {
    ...
    static int indexOfImpl(List<?> list, @cij Object obj) {
        if (list instanceof RandomAccess) {
    ...
    private static int indexOfRandomAccess(List<?> list, @cij Object obj) {
        int size = list.size();
        int i = 0;
        if (obj == null) {
            while (i < size) {
    ...
    static int lastIndexOfImpl(List<?> list, @cij Object obj) {
        if (list instanceof RandomAccess) {
    ...
    private static int lastIndexOfRandomAccess(List<?> list, @cij Object obj) {
        if (obj == null) {
