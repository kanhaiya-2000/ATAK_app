...
public final class Maps {
    ...
    public interface EntryTransformer<K, V1, V2> {
        V2 transformEntry(@cij K k, @cij V1 v1);
    }
    ...
    public static <C, K extends C, V> TreeMap<K, V> newTreeMap(@cij Comparator<C> comparator) {
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        static <V> MapDifference.ValueDifference<V> create(@cij V v, @cij V v2) {
            return new ValueDifferenceImpl(v, v2);
        }

        private ValueDifferenceImpl(@cij V v, @cij V v2) {
            this.left = v;
            this.right = v2;
        }
    ...
    static <E> Comparator<? super E> orNaturalOrder(@cij Comparator<? super E> comparator) {
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(@cij K k, @cij V v) {
    ...
    private static class UnmodifiableBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        UnmodifiableBiMap(BiMap<? extends K, ? extends V> biMap, @cij BiMap<V, K> biMap2) {
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @cij
        private Map.Entry<K, V2> transformEntry(@cij Map.Entry<K, V1> entry) {
            if (entry == null) {
                return null;
            }
    ...
    private static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        /* access modifiers changed from: package-private */
        public boolean apply(@cij Object obj, @cij V v) {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public V forcePut(@cij K k, @cij V v) {
            Preconditions.checkArgument(apply(k, v));
    ...
    /* access modifiers changed from: private */
    @cij
    public static <K, V> Map.Entry<K, V> unmodifiableOrNull(@cij Map.Entry<K, ? extends V> entry) {
        if (entry == null) {
            return null;
        }
    ...
    static <V> V safeGet(Map<?, V> map, @cij Object obj) {
        Preconditions.checkNotNull(map);
        try {
            return map.get(obj);
    ...
    static boolean containsKeyImpl(Map<?, ?> map, @cij Object obj) {
        return Iterators.contains(keyIterator(map.entrySet().iterator()), obj);
    }

    static boolean containsValueImpl(Map<?, ?> map, @cij Object obj) {
    ...
    @cij
    static <K> K keyOrNull(@cij Map.Entry<K, ?> entry) {
        if (entry == null) {
            return null;
        }
        return entry.getKey();
    ...
    @cij
    static <V> V valueOrNull(@cij Map.Entry<?, V> entry) {
        if (entry == null) {
            return null;
        }
        return entry.getValue();
