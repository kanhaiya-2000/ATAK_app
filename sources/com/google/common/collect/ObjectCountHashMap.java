...
class ObjectCountHashMap<K> {
    ...
    /* access modifiers changed from: package-private */
    public void insertEntry(int i, @cij K k, int i2, int i3) {
    ...
    public int remove(@cij Object obj) {
        return remove(obj, Hashing.smearedHash(obj));
    }

    private int remove(@cij Object obj, int i) {
