...
public abstract class Ordering<T> implements Comparator<T> {
    ...
    public abstract int compare(@cij T t, @cij T t2);
    ...
    public <E extends T> E min(@cij E e, @cij E e2) {
        return compare(e, e2) <= 0 ? e : e2;
    }

    public <E extends T> E min(@cij E e, @cij E e2, @cij E e3, E... eArr) {
    ...
    public <E extends T> E max(@cij E e, @cij E e2) {
        return compare(e, e2) >= 0 ? e : e2;
    }

    public <E extends T> E max(@cij E e, @cij E e2, @cij E e3, E... eArr) {
    ...
    @Deprecated
    public int binarySearch(List<? extends T> list, @cij T t) {
