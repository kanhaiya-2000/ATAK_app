...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public final ImmutableSet<Table.Cell<R, C, V>> createCellSet() {
        return isEmpty() ? ImmutableSet.m15175of() : new CellSet();
    }
    ...
    public final ImmutableCollection<V> createValues() {
        return isEmpty() ? ImmutableList.m15133of() : new Values();
    }
    ...
    static <R, C, V> RegularImmutableTable<R, C, V> forCells(List<Table.Cell<R, C, V>> list, @cij final Comparator<? super R> comparator, @cij final Comparator<? super C> comparator2) {
    ...
    private static <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(Iterable<Table.Cell<R, C, V>> iterable, @cij Comparator<? super R> comparator, @cij Comparator<? super C> comparator2) {
