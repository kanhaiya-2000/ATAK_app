...
final class Synchronized {
    ...
    static class SynchronizedObject implements Serializable {
        ...
        SynchronizedObject(Object obj, @cij Object obj2) {
    ...
    public static <E> Collection<E> collection(Collection<E> collection, @cij Object obj) {
    ...
    static class SynchronizedCollection<E> extends SynchronizedObject implements Collection<E> {
        ...
        private SynchronizedCollection(Collection<E> collection, @cij Object obj) {
    ...
    static <E> Set<E> set(Set<E> set, @cij Object obj) {
    ...
    static class SynchronizedSet<E> extends SynchronizedCollection<E> implements Set<E> {
        ...
        SynchronizedSet(Set<E> set, @cij Object obj) {
            super(set, obj);
        }
    ...
    /* access modifiers changed from: private */
    public static <E> SortedSet<E> sortedSet(SortedSet<E> sortedSet, @cij Object obj) {
    ...
    static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E> {
        ...
        SynchronizedSortedSet(SortedSet<E> sortedSet, @cij Object obj) {
            super(sortedSet, obj);
        }
    ...
    /* access modifiers changed from: private */
    public static <E> List<E> list(List<E> list, @cij Object obj) {
    ...
    private static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        SynchronizedList(List<E> list, @cij Object obj) {
            super(list, obj);
        }
    ...
    private static class SynchronizedRandomAccessList<E> extends SynchronizedList<E> implements RandomAccess {
        ...
        SynchronizedRandomAccessList(List<E> list, @cij Object obj) {
            super(list, obj);
        }
    }

    static <E> Multiset<E> multiset(Multiset<E> multiset, @cij Object obj) {
    ...
    private static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        SynchronizedMultiset(Multiset<E> multiset, @cij Object obj) {
            super(multiset, obj);
        }
    ...
    static <K, V> Multimap<K, V> multimap(Multimap<K, V> multimap, @cij Object obj) {
    ...
    private static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        SynchronizedMultimap(Multimap<K, V> multimap, @cij Object obj) {
            super(multimap, obj);
        }
    ...
    static <K, V> ListMultimap<K, V> listMultimap(ListMultimap<K, V> listMultimap, @cij Object obj) {
    ...
    private static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        SynchronizedListMultimap(ListMultimap<K, V> listMultimap, @cij Object obj) {
    ...
    static <K, V> SetMultimap<K, V> setMultimap(SetMultimap<K, V> setMultimap, @cij Object obj) {
    ...
    private static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        SynchronizedSetMultimap(SetMultimap<K, V> setMultimap, @cij Object obj) {
    ...
    static <K, V> SortedSetMultimap<K, V> sortedSetMultimap(SortedSetMultimap<K, V> sortedSetMultimap, @cij Object obj) {
    ...
    private static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        SynchronizedSortedSetMultimap(SortedSetMultimap<K, V> sortedSetMultimap, @cij Object obj) {
    ...
    /* access modifiers changed from: private */
    public static <E> Collection<E> typePreservingCollection(Collection<E> collection, @cij Object obj) {
    ...
    /* access modifiers changed from: private */
    public static <E> Set<E> typePreservingSet(Set<E> set, @cij Object obj) {
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Map.Entry<K, Collection<V>>> {
        ...
        SynchronizedAsMapEntries(Set<Map.Entry<K, Collection<V>>> set, @cij Object obj) {
            super(set, obj);
        }
    ...
    static <K, V> Map<K, V> map(Map<K, V> map, @cij Object obj) {
    ...
    private static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
        ...
        SynchronizedMap(Map<K, V> map, @cij Object obj) {
            super(map, obj);
        }
    ...
    static <K, V> SortedMap<K, V> sortedMap(SortedMap<K, V> sortedMap, @cij Object obj) {
    ...
    static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V> {
        ...
        SynchronizedSortedMap(SortedMap<K, V> sortedMap, @cij Object obj) {
            super(sortedMap, obj);
        }
    ...
    static <K, V> BiMap<K, V> biMap(BiMap<K, V> biMap, @cij Object obj) {
    ...
    static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        private SynchronizedBiMap(BiMap<K, V> biMap, @cij Object obj, @cij BiMap<V, K> biMap2) {
            super(biMap, obj);
            this.inverse = biMap2;
        }
    ...
    private static class SynchronizedAsMap<K, V> extends SynchronizedMap<K, Collection<V>> {
        ...
        SynchronizedAsMap(Map<K, Collection<V>> map, @cij Object obj) {
            super(map, obj);
        }
    ...
    private static class SynchronizedAsMapValues<V> extends SynchronizedCollection<Collection<V>> {
        ...
        SynchronizedAsMapValues(Collection<Collection<V>> collection, @cij Object obj) {
            super(collection, obj);
        }
    ...
    static class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E> {
        ...
        SynchronizedNavigableSet(NavigableSet<E> navigableSet, @cij Object obj) {
    ...
    static <E> NavigableSet<E> navigableSet(NavigableSet<E> navigableSet, @cij Object obj) {
    ...
    static <K, V> NavigableMap<K, V> navigableMap(NavigableMap<K, V> navigableMap, @cij Object obj) {
    ...
    static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        SynchronizedNavigableMap(NavigableMap<K, V> navigableMap, @cij Object obj) {
    ...
    /* access modifiers changed from: private */
    public static <K, V> Map.Entry<K, V> nullableSynchronizedEntry(@cij Map.Entry<K, V> entry, @cij Object obj) {
        if (entry == null) {
            return null;
        }
    ...
    private static class SynchronizedEntry<K, V> extends SynchronizedObject implements Map.Entry<K, V> {
        ...
        SynchronizedEntry(Map.Entry<K, V> entry, @cij Object obj) {
            super(entry, obj);
        }
    ...
    static <E> Queue<E> queue(Queue<E> queue, @cij Object obj) {
    ...
    private static class SynchronizedQueue<E> extends SynchronizedCollection<E> implements Queue<E> {
        ...
        SynchronizedQueue(Queue<E> queue, @cij Object obj) {
            super(queue, obj);
        }
    ...
    static <E> Deque<E> deque(Deque<E> deque, @cij Object obj) {
    ...
    private static final class SynchronizedDeque<E> extends SynchronizedQueue<E> implements Deque<E> {
        ...
        SynchronizedDeque(Deque<E> deque, @cij Object obj) {
            super(deque, obj);
        }
    ...
    private static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        public boolean contains(@cij Object obj, @cij Object obj2) {
            boolean contains;
            synchronized (this.mutex) {
        ...
        public boolean containsRow(@cij Object obj) {
            boolean containsRow;
            synchronized (this.mutex) {
        ...
        public boolean containsColumn(@cij Object obj) {
        ...
        public V get(@cij Object obj, @cij Object obj2) {
            V v;
            synchronized (this.mutex) {
        ...
        public V put(@cij R r, @cij C c, @cij V v) {
            V put;
            synchronized (this.mutex) {
        ...
        public V remove(@cij Object obj, @cij Object obj2) {
            V remove;
            synchronized (this.mutex) {
                remove = delegate().remove(obj, obj2);
            }
