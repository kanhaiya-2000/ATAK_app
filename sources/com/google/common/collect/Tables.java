...
public final class Tables {
    ...
    public static <R, C, V> Table.Cell<R, C, V> immutableCell(@cij R r, @cij C c, @cij V v) {
    ...
    static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        ImmutableCell(@cij R r, @cij C c, @cij V v) {
            this.rowKey = r;
            this.columnKey = c;
            this.value = v;
        }
    ...
    static boolean equalsImpl(Table<?, ?, ?> table, @cij Object obj) {
        if (obj == table) {
            return true;
        }
