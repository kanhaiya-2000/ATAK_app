...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private enum Aggregate {
        SIZE {
            ...
            /* access modifiers changed from: package-private */
            public long treeAggregate(@cij AvlNode<?> avlNode) {
                if (avlNode == null) {
                    return 0;
                }
        ...
        /* access modifiers changed from: package-private */
        public abstract long treeAggregate(@cij AvlNode<?> avlNode);
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(@cij Object obj) {
    ...
    public /* bridge */ /* synthetic */ SortedMultiset subMultiset(@cij Object obj, BoundType boundType, @cij Object obj2, BoundType boundType2) {
    ...
    public static <E> TreeMultiset<E> create(@cij Comparator<? super E> comparator) {
    ...
    private long aggregateBelowRange(Aggregate aggregate, @cij AvlNode<E> avlNode) {
        long treeAggregate;
        ...
        if (compare == 0) {
            int i = C53834.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()];
            if (i == 1) {
    ...
    /* synthetic */ class C53834 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.TreeMultiset.C53834.<clinit>():void");
        }
    }

    private long aggregateAboveRange(Aggregate aggregate, @cij AvlNode<E> avlNode) {
        long treeAggregate;
        ...
        if (compare == 0) {
            int i = C53834.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()];
            if (i == 1) {
                treeAggregate = (long) aggregate.nodeAggregate(avlNode);
    ...
    static int distinctElements(@cij AvlNode<?> avlNode) {
        if (avlNode == null) {
            return 0;
        }
    ...
    public int count(@cij Object obj) {
        try {
            AvlNode avlNode = this.rootReference.get();
    ...
    public int remove(@cij Object obj, int i) {
        CollectPreconditions.checkNonnegative(i, "occurrences");
        if (i == 0) {
            return count(obj);
        }
    ...
    public int setCount(@cij E e, int i) {
    ...
    public boolean setCount(@cij E e, int i, int i2) {
    ...
    public SortedMultiset<E> headMultiset(@cij E e, BoundType boundType) {
        return new TreeMultiset(this.rootReference, this.range.intersect(GeneralRange.upTo(comparator(), e, boundType)), this.header);
    }

    public SortedMultiset<E> tailMultiset(@cij E e, BoundType boundType) {
    ...
    private static final class Reference<T> {
        ...
        public void checkAndSet(@cij T t, T t2) {
            if (this.value == t) {
                this.value = t2;
                return;
            }
    ...
    private static final class AvlNode<E> {
        ...
        /* access modifiers changed from: package-private */
        public AvlNode<E> add(Comparator<? super E> comparator, @cij E e, int i, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            boolean z = true;
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
        ...
        /* access modifiers changed from: package-private */
        public AvlNode<E> remove(Comparator<? super E> comparator, @cij E e, int i, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        /* access modifiers changed from: package-private */
        public AvlNode<E> setCount(Comparator<? super E> comparator, @cij E e, int i, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        /* access modifiers changed from: package-private */
        public AvlNode<E> setCount(Comparator<? super E> comparator, @cij E e, int i, int i2, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        private static long totalCount(@cij AvlNode<?> avlNode) {
            if (avlNode == null) {
                return 0;
            }
            return avlNode.totalCount;
        ...
        private static int height(@cij AvlNode<?> avlNode) {
            if (avlNode == null) {
                return 0;
            }
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        Serialization.getFieldSetter(cls, JsonKeyConstants.HEADER).set(this, (Object) avlNode);
        successor(avlNode, avlNode);
