...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper {
    ...
    protected ArrayBasedUnicodeEscaper(Map<Character, String> map, int i, int i2, @cij String str) {
        this(ArrayBasedEscaperMap.create(map), i, i2, str);
    }

    protected ArrayBasedUnicodeEscaper(ArrayBasedEscaperMap arrayBasedEscaperMap, int i, int i2, @cij String str) {
