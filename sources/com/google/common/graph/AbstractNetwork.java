...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@cij Object obj) {
                        ...
                        if (!C54211.this.isOrderingCompatible(endpointPair) || !C54211.this.nodes().contains(endpointPair.nodeU()) || !C54211.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            return false;
                        }
                        return true;
                    }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m15176of(e));
    }
    ...
    public final boolean equals(@cij Object obj) {
        if (obj == this) {
            return true;
        }
