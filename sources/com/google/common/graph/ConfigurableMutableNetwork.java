...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m15232of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m15229of();
            }
            return DirectedNetworkConnections.m15230of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m15235of();
        } else {
            return UndirectedNetworkConnections.m15236of();
        }
    }
}
