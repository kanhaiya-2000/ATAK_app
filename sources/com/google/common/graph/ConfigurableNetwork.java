...
class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    ConfigurableNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(((Integer) networkBuilder.expectedNodeCount.mo19988or(10)).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo19988or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m15232of((Network<?, ?>) this, checkedReferenceNode, this.nodeConnections.get(checkedReferenceNode).adjacentNode(e));
    }
    ...
    /* access modifiers changed from: protected */
    public final boolean containsNode(@cij N n) {
        return this.nodeConnections.containsKey(n);
    }

    /* access modifiers changed from: protected */
    public final boolean containsEdge(@cij E e) {
