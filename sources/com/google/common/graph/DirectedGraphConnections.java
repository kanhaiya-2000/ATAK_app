...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    private DirectedGraphConnections(Map<N, Object> map, @cij List<NodeConnection<N>> list, int i, int i2) {
    ...
    /* synthetic */ class C54418 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.graph.DirectedGraphConnections.C54418.<clinit>():void");
        }
    }

    /* renamed from: of */
    static <N, V> DirectedGraphConnections<N, V> m15228of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i = C54418.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
        ...
        return new AbstractIterator<EndpointPair<N>>() {
            ...
            public com.google.common.graph.EndpointPair<N> computeNext() {
                ...
                L_0x0028:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.graph.DirectedGraphConnections.C54407.computeNext():com.google.common.graph.EndpointPair");
            }
        };
    }
    ...
    /* access modifiers changed from: private */
    public static boolean isPredecessor(@cij Object obj) {
        return obj == PRED || (obj instanceof PredAndSucc);
    }

    /* access modifiers changed from: private */
    public static boolean isSuccessor(@cij Object obj) {
