...
public final class Graphs {
    ...
    private static <N> boolean subgraphHasCycle(Graph<N> graph, Map<Object, NodeVisitState> map, N n, @cij N n2) {
    ...
    private static boolean canTraverseWithoutReusingEdge(Graph<?> graph, Object obj, @cij Object obj2) {
                ...
                public Iterator<EndpointPair<N>> iterator() {
                    return Iterators.transform(TransposedGraph.this.delegate().incidentEdges(this.node).iterator(), new Function<EndpointPair<N>, EndpointPair<N>>() {
                        public EndpointPair<N> apply(EndpointPair<N> endpointPair) {
                            return EndpointPair.m15231of((Graph<?>) TransposedGraph.this.delegate(), endpointPair.nodeV(), endpointPair.nodeU());
                        }
                    });
                }
            };
    ...
    private static class TransposedNetwork<N, E> extends ForwardingNetwork<N, E> {
        ...
        public EndpointPair<N> incidentNodes(E e) {
            ...
            return EndpointPair.m15232of((Network<?, ?>) this.network, incidentNodes.nodeV(), incidentNodes.nodeU());
        }
