...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C55021.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    /* synthetic */ class C55021 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C55021.<clinit>():void");
        }
    }
