...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m15115on('.').limit(4);
    private static final int IPV6_PART_COUNT = 8;
    private static final Splitter IPV6_SPLITTER = Splitter.m15115on(':').limit(10);
    ...
    public static final class TeredoInfo {
        ...
        public TeredoInfo(@cij Inet4Address inet4Address, @cij Inet4Address inet4Address2, int i, int i2) {
            boolean z = true;
