...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m15102on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m15115on('.');
    ...
    static {
        ...
        CharMatcher or = CharMatcher.inRange('a', 'z').mo20022or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = or;
        PART_CHAR_MATCHER = inRange.mo20022or(or).mo20022or(anyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m15104of(PublicSuffixType.REGISTRY));
    }
