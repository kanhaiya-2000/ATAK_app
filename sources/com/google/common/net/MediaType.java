...
import atakplugin.UASTool.C0862sx;
...
public final class MediaType {
    ...
    public static final MediaType APPLICATION_BINARY = createConstant(APPLICATION_TYPE, C0862sx.f6527a);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m15103on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m15147of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m15146of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m15104of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    optional = Optional.m15104of(Charset.forName(str2));
                    str = str2;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m15176of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m15104of(charset);
    ...
    /* renamed from: is */
    public boolean mo23671is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m15146of());
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                if ('\"' == tokenizer.previewChar()) {
                    tokenizer.consumeCharacter((char) bpg.f3093a);
