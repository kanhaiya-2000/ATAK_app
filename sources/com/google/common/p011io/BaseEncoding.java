...
public abstract class BaseEncoding {
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        StandardBaseEncoding(String str, String str2, @cij Character ch) {
            this(new Alphabet(str, str2.toCharArray()), ch);
        }

        StandardBaseEncoding(Alphabet alphabet2, @cij Character ch) {
        ...
        public com.google.common.p011io.BaseEncoding withPadChar(char r3) {
            /*
                r2 = this;
            ...
            L_0x001f:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.p011io.BaseEncoding.StandardBaseEncoding.withPadChar(char):com.google.common.io.BaseEncoding");
        }
        ...
        /* access modifiers changed from: package-private */
        public BaseEncoding newInstance(Alphabet alphabet2, @cij Character ch) {
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        /* access modifiers changed from: package-private */
        public BaseEncoding newInstance(Alphabet alphabet, @cij Character ch) {
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        Base64Encoding(String str, String str2, @cij Character ch) {
            this(new Alphabet(str, str2.toCharArray()), ch);
        }

        private Base64Encoding(Alphabet alphabet, @cij Character ch) {
            super(alphabet, ch);
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) {
            ...
            while (i2 >= 3) {
                ...
                appendable.append(this.alphabet.encode((b >>> Ascii.f8516FF) & 63));
                appendable.append(this.alphabet.encode((b >>> 6) & 63));
                appendable.append(this.alphabet.encode(b & bxu.f4219a));
                i2 -= 3;
                i = i5 + 1;
            }
            if (i < i3) {
        ...
        return new Reader() {
            ...
            public int read() {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p011io.BaseEncoding.C54843.read():int");
            }
    ...
    static Appendable separatingAppendable(Appendable appendable, String str, int i) {
        ...
        return new Appendable(i, appendable, str) {
            ...
            public Appendable append(@cij CharSequence charSequence, int i, int i2) {
                throw new UnsupportedOperationException();
            }

            public Appendable append(@cij CharSequence charSequence) {
                throw new UnsupportedOperationException();
            }
        };
    }
