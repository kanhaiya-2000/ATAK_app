...
public abstract class CharSource {
    ...
    private long countBySkipping(Reader reader) {
        long j = 0;
        while (true) {
            long skip = reader.skip(bfu.f2629b);
            if (skip == 0) {
                return j;
            }
            j += skip;
    ...
    private static class CharSequenceCharSource extends CharSource {
        ...
        public Optional<Long> lengthIfKnown() {
            return Optional.m15104of(Long.valueOf((long) this.seq.length()));
        }
        ...
        public <T> T readLines(com.google.common.p011io.LineProcessor<T> r3) {
            /*
                r2 = this;
