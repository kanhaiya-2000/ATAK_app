...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    /* access modifiers changed from: package-private */
    public abstract Object invokeInternal(@cij Object obj, Object[] objArr);
    ...
    public final R invoke(@cij T t, Object... objArr) {
        return invokeInternal(t, (Object[]) Preconditions.checkNotNull(objArr));
    }

    public final TypeToken<? extends R> getReturnType() {
        return TypeToken.m15273of(getGenericReturnType());
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add((Object) new Parameter(this, i, TypeToken.m15273of(genericParameterTypes[i]), parameterAnnotations[i]));
        }
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        ...
        for (Type of : getGenericExceptionTypes()) {
            builder.add((Object) TypeToken.m15273of(of));
        }
        return builder.build();
    }

    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> cls) {
        return returning(TypeToken.m15272of(cls));
    }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.m15272of(getDeclaringClass());
    }
    ...
    static class MethodInvokable<T> extends Invokable<T, Object> {
        ...
        /* access modifiers changed from: package-private */
        public final Object invokeInternal(@cij Object obj, Object[] objArr) {
