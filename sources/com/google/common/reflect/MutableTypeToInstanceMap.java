...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    public <T extends B> T getInstance(Class<T> cls) {
        return trustedGet(TypeToken.m15272of(cls));
    }
    ...
    @cij
    public <T extends B> T putInstance(Class<T> cls, @cij T t) {
        return trustedPut(TypeToken.m15272of(cls), t);
    }

    @cij
    public <T extends B> T putInstance(TypeToken<T> typeToken, @cij T t) {
    ...
    @cij
    private <T extends B> T trustedPut(TypeToken<T> typeToken, @cij T t) {
