...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        TypeTable() {
            this.map = ImmutableMap.m15152of();
        }
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f8598id;
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f8598id.incrementAndGet() + "-of ? extends " + Joiner.m15102on((char) bpg.f3095c).join((Object[]) typeArr), typeArr);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f8598id) {
                /* access modifiers changed from: package-private */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
        ...
        private Type captureNullable(@cij Type type) {
            if (type == null) {
                return null;
            }
            return capture(type);
