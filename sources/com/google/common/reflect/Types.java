...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m15103on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    static ParameterizedType newParameterizedTypeWithOwner(@cij Type type, Class<?> cls, Type... typeArr) {
        if (type == null) {
    ...
    private static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        ParameterizedTypeImpl(@cij Type type, Class<?> cls, Type[] typeArr) {
    ...
    static final class NativeTypeVariableEquals<X> {
        ...
        static {
            ...
            NATIVE_TYPE_VARIABLE_ONLY = !cls.getTypeParameters()[0].equals(Types.newArtificialTypeVariable(cls, CameraParamsConfig.param_X, new Type[0]));
        }
    }
