...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    private static final class Cancellation {
        ...
        Cancellation(boolean z, @cij Throwable th) {
    ...
    /* access modifiers changed from: package-private */
    public final void maybePropagateCancellationTo(@cij Future<?> future) {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:3:?, code lost:
            r0 = (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new com.google.common.util.concurrent.AbstractFuture.UnsafeAtomicHelper.C55511());
         */
    ...
    private static CancellationException cancellationExceptionWithCause(@cij String str, @cij Throwable th) {
