...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C55666.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    /* synthetic */ class C55666 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.util.concurrent.AbstractService.C55666.<clinit>():void");
        }
    }
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            Service.State state = state();
            int i = C55666.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
    ...
    private static final class StateSnapshot {
        ...
        StateSnapshot(Service.State state2, boolean z, @cij Throwable th) {
            boolean z2 = false;
