...
abstract class AbstractTransformFuture<I, O, F, T> extends FluentFuture.TrustedFuture<O> implements Runnable {
    ...
    @cij
    public abstract T doTransform(F f, @cij I i);

    /* access modifiers changed from: package-private */
    public abstract void setResult(@cij T t);
    ...
    private static final class AsyncTransformFuture<I, O> extends AbstractTransformFuture<I, O, AsyncFunction<? super I, ? extends O>, ListenableFuture<? extends O>> {
        ...
        /* access modifiers changed from: package-private */
        public ListenableFuture<? extends O> doTransform(AsyncFunction<? super I, ? extends O> asyncFunction, @cij I i) {
    ...
    private static final class TransformFuture<I, O> extends AbstractTransformFuture<I, O, Function<? super I, ? extends O>, O> {
        ...
        /* access modifiers changed from: package-private */
        @cij
        public O doTransform(Function<? super I, ? extends O> function, @cij I i) {
            return function.apply(i);
        }

        /* access modifiers changed from: package-private */
        public void setResult(@cij O o) {
            set(o);
        }
    }
}
