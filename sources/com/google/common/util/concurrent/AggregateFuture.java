...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    public abstract void collectOneValue(int i, @cij InputT inputt);
    ...
    /* access modifiers changed from: private */
    public void decrementCountAndMaybeComplete(@cij ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
    ...
    private void processCompleted(@cij ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
        if (immutableCollection != null) {
            int i = 0;
