...
public final class ServiceManager {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m15134of(new NoOpService());
        }
    ...
    private static final class ServiceManagerState {
        ...
        public void awaitHealthy(long j, TimeUnit timeUnit) {
            ...
            try {
                ...
                throw new TimeoutException("Timeout waiting for the services to become healthy. The following services have not started: " + Multimaps.filterKeys(this.servicesByState, Predicates.m15108in(ImmutableSet.m15177of(Service.State.NEW, Service.State.STARTING))));
            } finally {
                this.monitor.leave();
            }
        }
        ...
        public void awaitStopped(long j, TimeUnit timeUnit) {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, j, timeUnit)) {
                    throw new TimeoutException("Timeout waiting for the services to stop. The following services have not stopped: " + Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.m15108in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                }
            } finally {
                this.monitor.leave();
            }
