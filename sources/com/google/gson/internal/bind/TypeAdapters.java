...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C569730.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        C56731 r0 = new TypeAdapter<Class>() {
        ...
        C56842 r02 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) {
                ...
                L_0x001b:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C570436.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0082:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C56842.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C56963 r03 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C57065 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C57076 r05 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C57087 r06 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C567814 r07 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) {
                JsonToken peek = jsonReader.peek();
                int i = C570436.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                if (i == 1) {
        ...
        C567915 r08 = new TypeAdapter<Character>() {
        ...
        C568016 r09 = new TypeAdapter<String>() {
        ...
        C568319 r010 = new TypeAdapter<StringBuilder>() {
        ...
        C568520 r011 = new TypeAdapter<StringBuffer>() {
        ...
        C568621 r012 = new TypeAdapter<URL>() {
        ...
        C568722 r013 = new TypeAdapter<URI>() {
        ...
        C568823 r014 = new TypeAdapter<InetAddress>() {
        ...
        C568924 r015 = new TypeAdapter<UUID>() {
        ...
        C569327 r016 = new TypeAdapter<Calendar>() {
        ...
        C569428 r017 = new TypeAdapter<Locale>() {
        ...
        C569529 r018 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) {
                switch (C570436.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    /* synthetic */ class C570436 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C570436.<clinit>():void");
        }
    }
