...
public class JsonReader implements Closeable {
    ...
    public String nextName() {
        ...
        if (i == 14) {
            ...
            str = nextQuotedValue(bpg.f3093a);
        } else {
    ...
    public double nextDouble() {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? '\'' : bpg.f3093a);
        } else if (i == 10) {
