...
final class JsonSerializer$serializeChangeFlightMode$1 extends bfr implements bdl<JSONObject, aqr> {
    final /* synthetic */ ChangeFlightMode $changeFlightMode;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    JsonSerializer$serializeChangeFlightMode$1(ChangeFlightMode changeFlightMode) {
        super(1);
        this.$changeFlightMode = changeFlightMode;
    }
    ...
    public final void invoke(JSONObject jSONObject) {
        ...
        jSONObject.put(JsonKeyConstants.DESIRED_MODE, JsonSerializationUtilitiesKt.toJsonValue(this.$changeFlightMode.getDesiredMode()));
    }
}
