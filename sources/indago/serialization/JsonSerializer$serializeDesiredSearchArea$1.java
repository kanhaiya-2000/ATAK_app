...
final class JsonSerializer$serializeDesiredSearchArea$1 extends bfr implements bdl<JSONObject, aqr> {
    final /* synthetic */ DesiredSearchArea $desiredSearchArea;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    JsonSerializer$serializeDesiredSearchArea$1(DesiredSearchArea desiredSearchArea) {
        super(1);
        this.$desiredSearchArea = desiredSearchArea;
    }
    ...
    public final void invoke(JSONObject jSONObject) {
        ...
        jSONObject.put(JsonKeyConstants.POLYGON, JsonSerializationUtilitiesKt.toJsonArray(this.$desiredSearchArea.getPolygon()));
    }
}
