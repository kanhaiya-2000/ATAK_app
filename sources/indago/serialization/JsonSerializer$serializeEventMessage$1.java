...
final class JsonSerializer$serializeEventMessage$1 extends bfr implements bdl<JSONObject, aqr> {
    final /* synthetic */ EventMessage $eventMessage;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    JsonSerializer$serializeEventMessage$1(EventMessage eventMessage) {
        super(1);
    ...
    public final void invoke(JSONObject jSONObject) {
        ...
        jSONObject.put(JsonKeyConstants.MESSAGE_TYPE, JsonSerializationUtilitiesKt.toJsonValue(this.$eventMessage.getPriority()));
        jSONObject.put("message", this.$eventMessage.getMessage());
    }
}
