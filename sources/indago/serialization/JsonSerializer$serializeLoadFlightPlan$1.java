...
final class JsonSerializer$serializeLoadFlightPlan$1 extends bfr implements bdl<JSONObject, aqr> {
    final /* synthetic */ LoadFlightPlan $loadFlightPlan;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    JsonSerializer$serializeLoadFlightPlan$1(LoadFlightPlan loadFlightPlan) {
        super(1);
        this.$loadFlightPlan = loadFlightPlan;
    }
    ...
    public final void invoke(JSONObject jSONObject) {
        ...
        jSONObject.put(JsonKeyConstants.FLIGHT_PLAN, this.$loadFlightPlan.getFlightPlan());
    }
}
