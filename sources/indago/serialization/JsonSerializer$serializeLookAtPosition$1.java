...
final class JsonSerializer$serializeLookAtPosition$1 extends bfr implements bdl<JSONObject, aqr> {
    final /* synthetic */ LookAtPosition $lookAtPosition;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    JsonSerializer$serializeLookAtPosition$1(LookAtPosition lookAtPosition) {
        super(1);
    ...
    public final void invoke(JSONObject jSONObject) {
        ...
        jSONObject.put(JsonKeyConstants.POSITION, JsonSerializationUtilitiesKt.toJsonObject(this.$lookAtPosition.getLocation()));
    }
}
